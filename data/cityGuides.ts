...
export const cityGuides: Record<string, CityGuide> = {
  ...
  "quito": {
    "visaFiscal": { "content": "Ecuador ofrece una visa de nómada digital que exige unos ingresos mínimos de 1.446 $/mes de fuente extranjera (tres veces el salario básico unificado de 2026), acreditados mediante extractos bancarios o contrato laboral de los 3 meses previos a la solicitud. Concede 2 años de residencia temporal, renovable, y tras 21 meses de presencia continuada en el país (con un máximo de 90 días fuera) se puede optar a la residencia permanente.\n\nLos documentos exigidos incluyen pasaporte con más de 6 meses de validez, certificado de antecedentes penales apostillado y traducido, seguro médico que cubra los 2 años de estancia con cobertura en Ecuador, y prueba de alojamiento. Toda la documentación extranjera debe apostillarse y traducirse al español por un traductor autorizado.\n\nEn el plano fiscal, se es residente si se permanece 183 días en Ecuador en un periodo de 12 meses, lo que activa la obligación de declarar la renta mundial según la tabla progresiva del impuesto a la renta ecuatoriano.", "sources": [{ "label": "Ecuador Digital Nomad Visa 2026 – MyEcuadorVisa", "url": "https://myecuadorvisa.com/digital-nomad-visa/" }] },
    "sanidad": { "content": "Entre los hospitales privados de referencia en Quito están el Hospital Metropolitano, acreditado por la JCI y el más reconocido internacionalmente; el Hospital de los Valles, en las afueras hacia Cumbayá; y el Hospital Vozandes Quito, con buena reputación entre la comunidad expatriada.\n\nUn seguro internacional (SafetyWing, Cigna Global) es muy recomendable: aunque los precios sin seguro son bajos comparados con Europa o EE. UU., la altitud de Quito (casi 2.850 metros) puede requerir atención médica de adaptación para quien llega de zonas bajas.", "sources": [{ "label": "Hospital Metropolitano Quito – About", "url": "https://www.hospitalmetropolitano.org/" }] },
    "barrios": { "content": "1. **La Floresta** — el barrio bohemio y creativo, con la mayor concentración de cafés con wifi y coworkings.\n2. **Cumbayá** — suburbio residencial en un valle más cálido a las afueras, muy popular entre expatriados y familias.\n3. **La Mariscal** — el centro turístico y de vida nocturna, práctico pero más ruidoso.\n4. **Centro Histórico** — el casco colonial, Patrimonio de la Humanidad, con encanto pero menos infraestructura moderna.\n\nEntre los coworkings, Impaqto es la referencia local con varias sedes en La Floresta y el norte de la ciudad; y Comunatel ofrece espacios más pequeños orientados a freelancers.", "sources": [{ "label": "Impaqto Coworking – About", "url": "https://www.impaqto.net/" }] },
  },
  "chicago": {
    "visaFiscal": { "content": "Al igual que en el resto de Estados Unidos, Chicago no ofrece ningún visado de nómada digital. La entrada bajo ESTA permite hasta 90 días de turismo o negocios puntuales, sin autorización para trabajar, y la normativa se fija en dónde se realiza físicamente el trabajo, no en la ubicación del cliente. La excepción fiscal de 90 días y 3.000 $ de facturación a clientes extranjeros aplica igual que en el resto del país, sin legalizar el trabajo a efectos migratorios.\n\nPara estancias más largas, las únicas vías reales son los visados de trabajo tradicionales (O-1, L-1, E-2, H-1B), habituales en Chicago por su peso en finanzas, consultoría y tecnología.", "sources": [{ "label": "Remote Work Visa 2026 – NNU Immigration", "url": "https://www.nnuimmigration.com/remote-work-visa/" }] },
    "sanidad": { "content": "Estados Unidos no tiene sanidad pública universal y los precios sin seguro pueden ser muy altos. Entre los hospitales de referencia en Chicago están el Northwestern Memorial Hospital, el Rush University Medical Center y el University of Chicago Medical Center. Es imprescindible contratar un seguro médico internacional (Cigna Global, SafetyWing o similar) antes de viajar.\n\nSin seguro, una visita a urgencias puede superar fácilmente los 1.000-3.000 $, y una consulta de médico general privada ronda los 150-300 $.", "sources": [{ "label": "Northwestern Memorial Hospital – About", "url": "https://www.nm.org/locations/northwestern-memorial-hospital" }] },
    "barrios": { "content": "1. **Wicker Park** — el barrio creativo y alternativo, con la mejor vida nocturna y buena oferta de cafés con wifi.\n2. **Lincoln Park** — residencial y elegante, junto al lago Michigan, de los más caros.\n3. **West Loop** — antiguo distrito industrial reconvertido, epicentro gastronómico y con presencia tech creciente.\n4. **Logan Square** — más asequible, ambiente joven y en plena gentrificación.\n\nEntre los coworkings, 1871 es el hub de startups y tecnología más importante de Chicago, en el Merchandise Mart; WeWork tiene varias sedes por la ciudad; e Industrious ofrece espacios boutique en el Loop y West Loop.", "sources": [{ "label": "1871 Chicago – About", "url": "https://1871.com/about/" }] },
  },
  "casablanca": {
    "visaFiscal": { "content": "Marruecos no cuenta con un visado de nómada digital específico. Los ciudadanos de la UE, incluida España, pueden entrar sin visado previo y permanecer hasta 90 días como turistas, sin autorización formal para trabajar. Para estancias más largas, la vía es la Carte de Séjour (tarjeta de residencia), concedida inicialmente por 1 año y renovable por 1, 5 o 10 años, que exige demostrar recursos económicos suficientes y estables, sin un umbral mínimo de ingresos fijado explícitamente.\n\nEntre los documentos requeridos están el pasaporte, prueba de alojamiento, extractos bancarios, certificado médico y seguro de salud, y antecedentes penales limpios. El trámite tarda entre 1 y 2 meses y la tasa de la tarjeta de residencia es de solo 100 DH (unos 10 $). No existe un régimen fiscal específico para nómadas: la residencia fiscal marroquí se activa principalmente al superar los 183 días de estancia.", "sources": [{ "label": "Morocco Digital Nomad Visa 2026 – Citizen Remote", "url": "https://citizenremote.com/visas/morocco-digital-nomad-visa/" }] },
    "sanidad": { "content": "Entre los centros privados de referencia en Casablanca están la Clinique Badr, con buena reputación en cirugía y maternidad; la Clinique Yasmine; y el CHU Ibn Rochd como referencia del sistema público para casos de mayor complejidad.\n\nUn seguro internacional (SafetyWing, Cigna Global) es muy recomendable: la sanidad privada marroquí tiene precios bajos comparada con Europa, pero los hospitales privados de nivel internacional suelen exigir depósito o prueba de cobertura al ingresar.", "sources": [{ "label": "Clinique Badr – Présentation", "url": "https://www.cliniquebadr.com/" }] },
    "barrios": { "content": "1. **Gauthier** — barrio céntrico y tranquilo, con buena oferta de cafés con wifi y cercanía al centro de negocios.\n2. **Racine** — residencial y elegante, con edificios de estilo art déco de la época colonial.\n3. **Ain Diab** — el frente marítimo, con playa urbana, restaurantes y ambiente más relajado.\n4. **Maarif** — zona comercial y de negocios en auge, con oficinas y centros comerciales modernos.\n\nEntre los coworkings, Cosmopolitan Casablanca y Nest CoWork son los espacios más orientados a freelancers y startups, concentrados sobre todo en Gauthier y Maarif.", "sources": [{ "label": "Casablanca Digital Nomad Guide – Nomads.com", "url": "https://nomads.com/guide/casablanca" }] },
  },
  "vilna": {
    "visaFiscal": { "content": "Lituania no ofrece un visado de nómada digital específico; la vía para no comunitarios que quieren instalarse por cuenta propia es la Start-Up Visa, sin un requisito mínimo de ingresos fijado, pero exigiendo demostrar solvencia suficiente para mantenerse durante la estancia. Concede 1 año de residencia, ampliable, y el trámite completo (visado más permiso de residencia temporal) cuesta unos 300 €, con un plazo de resolución de hasta 60 días.\n\nLos ciudadanos de la UE, incluidos los españoles, pueden simplemente residir y trabajar en remoto sin ningún trámite de visado al ser territorio Schengen y de la Unión Europea. Los documentos para la Start-Up Visa incluyen formulario de solicitud, plan de desarrollo del proyecto, pasaporte, seguro médico y certificado del departamento de migración. En el plano fiscal, la residencia se activa al superar los 183 días de estancia en un periodo de 12 meses.", "sources": [{ "label": "Lithuania Digital Nomad / Start-Up Visa – Citizen Remote", "url": "https://citizenremote.com/visas/lithuania-digital-nomad-visa/" }] },
    "sanidad": { "content": "Entre los centros de referencia en Vilna están el Hospital Universitario de Santaros Klinikos, el mayor y más completo del país; Nordclinic, un centro privado orientado a pacientes internacionales; y Kardiolita, especializado en cardiología y cirugía.\n\nLa sanidad privada lituana combina buena calidad con precios notablemente más bajos que Europa occidental. Un seguro internacional (SafetyWing, Cigna Global) sigue siendo recomendable para acceder sin fricciones a la red privada.", "sources": [{ "label": "Santaros Klinikos – About", "url": "https://www.santa.lt/en/" }] },
    "barrios": { "content": "1. **Senamiestis (Casco Antiguo)** — el corazón histórico barroco, Patrimonio de la Humanidad, con la mayor concentración de cafés y vida cultural.\n2. **Užupis** — el barrio bohemio y artístico, autoproclamada \"república\" independiente dentro de la ciudad, comparado a menudo con el Montmartre parisino.\n3. **Naujamiestis (Ciudad Nueva)** — el distrito de negocios moderno, con oficinas y rascacielos.\n4. **Žvėrynas** — residencial y verde, junto al río Neris, más tranquilo.\n\nEntre los coworkings, Vilnius TechPark es el hub tecnológico de referencia del país; y Spaces cuenta con sedes bien conectadas en el centro y Naujamiestis.", "sources": [{ "label": "Vilnius TechPark – About", "url": "https://vilniustechpark.com/" }] },
  },
  "baku": {
    "visaFiscal": { "content": "Azerbaiyán no cuenta con visado de nómada digital. La vía habitual es el e-Visa turístico, de entrada única, válido durante 90 días desde su emisión pero con una estancia máxima de solo 30 días, y con un coste de 69 $. El e-Visa no se puede ampliar online: cualquier prórroga debe tramitarse presencialmente en el Servicio Estatal de Migración en Bakú una vez dentro del país.\n\nPara estancias más largas, la única vía real es solicitar un permiso de residencia temporal, que exige contrato de trabajo local, matrícula de empresa propia o vínculo familiar, ninguno de los cuales es habitual entre nómadas digitales. No existe un régimen fiscal específico para nómadas, y la residencia fiscal se activa principalmente al superar los 183 días de estancia.", "sources": [{ "label": "Azerbaijan E-Visa Guide 2026", "url": "https://evisa.org.az/en/article/azerbaijan-electronic-visa-complete-guide" }] },
    "sanidad": { "content": "Entre los hospitales privados de referencia en Bakú están el Bona Dea International Hospital, especializado en salud materno-infantil con estándares internacionales; y el Medipol Baku International Hospital, parte de una cadena turca con buena reputación regional.\n\nUn seguro internacional (SafetyWing, Cigna Global) es recomendable, ya que los hospitales privados de nivel internacional en Bakú suelen exigir pago por adelantado o prueba de cobertura antes de atender a pacientes extranjeros.", "sources": [{ "label": "Bona Dea International Hospital – About", "url": "https://bonadea.az/en/" }] },
    "barrios": { "content": "1. **Icherisheher (Ciudad Vieja)** — el casco amurallado otomano, Patrimonio de la Humanidad, con calles empedradas y encanto histórico.\n2. **Nizami Street** — la arteria comercial y peatonal más animada, con tiendas, cafés y buena conexión.\n3. **White City** — desarrollo moderno de nueva construcción, con edificios de oficinas y apartamentos de alto nivel.\n4. **Bulevar (Paseo del Caspio)** — el frente marítimo junto a las Flame Towers, con parques y restaurantes.\n\nLa comunidad nómada digital en Bakú es casi inexistente, pero existen espacios como WORK.az y ONE Coworking Baku, concentrados sobre todo en el centro y Nizami Street.", "sources": [{ "label": "Baku Digital Nomad Guide – Nomads.com", "url": "https://nomads.com/guide/baku" }] },
  },
  "zurich": {
    "visaFiscal": { "content": "Suiza no tiene un visado de nómada digital específico. Los ciudadanos de la UE/EFTA (incluida España) pueden residir con el permiso de \"suficiencia financiera\": basta con demostrar medios propios de subsistencia y un seguro médico, sin necesidad de patrocinio de un empleador.\n\nPara no comunitarios la situación es mucho más restrictiva: no es posible obtener un permiso de residencia solo por ser autónomo o trabajar en remoto para una empresa extranjera. Las rutas realistas pasan por un contrato de trabajo con patrocinio de empleador suizo (permiso B o L, sujeto a cupos para terceros países), o por la tributación a tanto alzado disponible en algunos cantones para personas con rentas muy altas y sin actividad lucrativa en Suiza.\n\nQuien fija su residencia en Suiza pasa a ser residente fiscal, con tributación sobre la renta mundial según el sistema federal, cantonal y municipal.", "sources": [{ "label": "Switzerland Has No Digital Nomad Visa – Remote Work Europe", "url": "https://remoteworkeurope.eu/insights/switzerland-no-digital-nomad-visa-four-routes/" }] },
    "sanidad": { "content": "Suiza no tiene sanidad pública gratuita: el seguro médico es obligatorio para todo residente, contratado con una aseguradora privada homologada, aunque la cobertura básica (LAMal) incluye la mayoría de tratamientos por ley.\n\nEntre los hospitales de referencia están el Universitätsspital Zürich (público, uno de los mejores de Europa), la Klinik Hirslanden (privada, habitaciones individuales y tiempos de espera más cortos), el Stadtspital Triemli y el Balgrist University Hospital, especializado en traumatología. El personal médico suele hablar inglés con fluidez.", "sources": [{ "label": "Healthcare and health insurance for expats in Zurich – Expat Arrivals", "url": "https://www.expatarrivals.com/europe/switzerland/zurich/healthcare-zurich" }] },
    "barrios": { "content": "1. **Zúrich Oeste (Kreis 5)** — antigua zona industrial reconvertida en el barrio más de moda, con lofts, vida nocturna y ambiente creativo.\n2. **Seefeld** — barrio elegante junto al lago, con paseos, terrazas y un nivel de vida alto.\n3. **Enge** — zona tranquila y céntrica junto al lago, con buenas conexiones de tranvía y tren.\n4. **Oerlikon** — distrito moderno e internacional a 10-12 minutos de la estación central, con edificios nuevos y buena relación calidad-precio para Zúrich.\n\nEl coworking es abundante: Impact Hub Zürich y varias sedes de Spaces cubren la mayoría de los barrios céntricos.", "sources": [{ "label": "Best Neighborhoods in Zurich for Expats – Life in Zurich", "url": "https://lifeinzurich.com/best-neighborhoods-in-zurich-for-expats/" }] },
  },
  "valparaiso": {
    "visaFiscal": { "content": "Chile no tiene un visado de nómada digital específico: la vía habitual es la Visa de Estadía Transitoria por Turismo, que se puede tramitar online (SAC Ciudadano) demostrando ingresos regulares de al menos 1.000 $/mes mediante nóminas o extractos bancarios. Concede una estancia inicial de 90 días, ampliable otros 90 días más pagando una tasa adicional, hasta un máximo de 6 meses.\n\nPara estancias más largas hace falta optar a una visa de residencia temporal con un motivo específico (trabajo, inversión, vínculo familiar), ya que Chile no ofrece un camino de residencia solo por trabajar en remoto para una empresa extranjera.\n\nEn materia fiscal, quien supera los 183 días de estancia en un periodo de 12 meses pasa a ser residente fiscal en Chile y debe declarar su renta mundial a partir del segundo año de residencia.", "sources": [{ "label": "Chile Digital Nomad Visa Options – Citizen Remote", "url": "https://citizenremote.com/visas/chile-digital-nomad-visa/" }] },
    "sanidad": { "content": "El sistema de salud chileno combina Fonasa (público) e Isapres (seguros privados), pero un extranjero de paso normalmente recurre a un seguro de viaje o salud internacional, ya que no tiene acceso directo a ninguno de los dos sin residencia formal.\n\nEn Valparaíso y la vecina Viña del Mar, los centros de referencia son el Hospital Carlos Van Buren (público) y el Hospital Naval Almirante Nef; para atención privada, muchos residentes optan por clínicas en Viña del Mar, a solo 20 minutos, con mejor equipamiento que el propio Valparaíso.", "sources": [{ "label": "La salud en Chile para expatriados – Expat.cl", "url": "https://www.expat.cl/es/guia-chile/salud/" }] },
    "barrios": { "content": "1. **Cerro Alegre** — el barrio bohemio por excelencia, con casas de colores, cafés y galerías de arte; el más buscado por nómadas y visitantes.\n2. **Cerro Concepción** — zona histórica con tiendas boutique, restaurantes y algunas de las mejores vistas de la bahía.\n3. **Cerro Bellavista** — conocido por su arte urbano, museos al aire libre y ambiente creativo.\n4. **Barrio Puerto** — el corazón marítimo de la ciudad, con mercados de pescado y bares, algo más deteriorado pero con carácter.\n\nEl coworking más consolidado es HIT Valpo, con Paralelo Cowork y Valparaíso MakerSpace como alternativas; varios cafés como Taller Café también funcionan bien para trabajar unas horas.", "sources": [{ "label": "Valparaíso Guide for Digital Nomads – Digital Nomad Hub", "url": "https://www.digitalnomadhub.com/go/chile/valparaiso/" }] },
  },
  "beirut": {
    "visaFiscal": { "content": "Un ciudadano español puede entrar en Líbano con una visa a la llegada gratuita, válida para 1 mes y ampliable por 2 meses más en el país, hasta un total de 3 meses. Es uno de los trámites de entrada más sencillos de Oriente Próximo para un europeo, aunque no existe ningún visado ni permiso pensado para trabajar en remoto de forma prolongada.\n\nPara estancias más largas hace falta un permiso de residencia gestionado con patrocinio local, un trámite considerablemente más burocrático dado el contexto de inestabilidad institucional del país.\n\nEn materia fiscal, Líbano no tiene un criterio claro ni ampliamente aplicado de residencia fiscal para extranjeros de paso; en la práctica, la inmensa mayoría de nómadas digitales que pasan una temporada corta siguen tributando en su país de origen.", "sources": [{ "label": "Visa requirements for Spanish citizens – Wikipedia", "url": "https://en.wikipedia.org/wiki/Visa_requirements_for_Spanish_citizens" }] },
    "sanidad": { "content": "No hay sanidad pública accesible para extranjeros, así que un seguro de salud internacional con buena cobertura es imprescindible. El sistema sanitario libanés está muy privatizado incluso para los propios residentes.\n\nEl centro de referencia regional es el American University of Beirut Medical Center (AUBMC), uno de los mejores hospitales de Oriente Próximo; también destacan el Hôtel-Dieu de France y el Clemenceau Medical Center. Conviene tener en cuenta los cortes de electricidad frecuentes, que algunos hospitales privados mitigan con generadores propios.", "sources": [{ "label": "American University of Beirut Medical Center", "url": "https://aubmc.org.lb/" }] },
    "barrios": { "content": "Beirut no tiene una zonificación tan clara para nómadas como otras capitales, pero **Hamra**, cerca de la Universidad Americana, concentra cafés con wifi y un ambiente cosmopolita; **Mar Mikhael** y **Gemmayzeh** son los barrios de moda para vida nocturna y restaurantes, con edificios de arquitectura otomana reconvertidos; y **Achrafieh** ofrece un ambiente más residencial y tranquilo.\n\nEl coworking incluye espacios como Alt City y Speed@BDD, aunque la oferta es más limitada que en otras capitales del catálogo, y la calidad del internet fijo (en torno a 19 Mbps de media nacional) obliga a muchos a depender de datos móviles 4G como respaldo.", "sources": [{ "label": "Beirut – Nomads.com", "url": "https://nomads.com/neighborhoods/beirut" }] },
  },
  "san-juan": {
    "visaFiscal": { "content": "Puerto Rico es territorio de Estados Unidos, así que un ciudadano estadounidense no necesita pasaporte ni visado para vivir y trabajar allí; para un español, en cambio, se aplican las mismas normas de entrada que para el resto de EE. UU. (ESTA o visado, según el motivo y duración de la estancia).\n\nLo que hace especial a Puerto Rico es su régimen fiscal propio, la conocida Ley 60: quienes trasladan su residencia fiscal a la isla y cumplen los requisitos (183 días de presencia física al año, entre otros) pueden beneficiarse de un 0% sobre ganancias de capital y un tipo reducido del 4% sobre ciertos ingresos de exportación de servicios. Es un incentivo pensado sobre todo para estadounidenses, ya que un español que se traslade seguiría sujeto a las normas fiscales españolas de residencia y posible doble imposición.\n\nConviene asesorarse con un especialista fiscal antes de planear una estancia larga basada en estos incentivos.", "sources": [{ "label": "How You Can Benefit by Working Remotely from Puerto Rico – PRelocate", "url": "https://relocatepuertorico.com/how-you-can-benefit-by-working-remotely-from-puerto-rico/" }] },
    "sanidad": { "content": "El sistema sanitario de Puerto Rico está integrado en buena parte con el de EE. UU., con hospitales de nivel similar al continente. Auxilio Mutuo es uno de los hospitales privados más reputados de San Juan, junto con Hospital HIMA San Pablo y Pavia Hospital.\n\nUn seguro médico internacional o estadounidense con cobertura en Puerto Rico es imprescindible, ya que los precios sin seguro pueden ser tan altos como en EE. UU. continental.", "sources": [{ "label": "Healthcare and health insurance for expats in Puerto Rico – Expat Arrivals", "url": "https://www.expatarrivals.com/americas/puerto-rico/healthcare-puerto-rico" }] },
    "barrios": { "content": "1. **Viejo San Juan** — el casco histórico colonial, con cafés con wifi fiable, vida nocturna y las fortalezas de Castillo San Cristóbal.\n2. **Ocean Park** — barrio residencial y seguro junto a la playa, con mercados pequeños y aguas tranquilas para nadar.\n3. **Miramar** — zona más elegante, con buenos restaurantes, cines y cafeterías de calidad.\n\nEntre los coworkings, Piloto 151 fue el primer espacio de coworking de Puerto Rico y tiene varias sedes; CoSPAZIO destaca por sus vistas al mar, y The Workplace, en Miramar, ofrece bonos de día desde 19 $.", "sources": [{ "label": "Digital Nomad Guide to San Juan, Puerto Rico – Outsite", "url": "https://www.outsite.co/blog/digital-nomad-guide-to-san-juan-puerto-rico" }] },
  },
  "rotterdam": {
    "visaFiscal": { "content": "Como ciudadano de la UE, un español puede instalarse y trabajar en Róterdam sin ningún visado ni permiso especial, igual que en cualquier otra ciudad de los Países Bajos: basta con empadronarse (inschrijving) en el ayuntamiento si la estancia supera los 4 meses.\n\nPara no comunitarios, la vía habitual es el permiso de residencia por autónomo (Zelfstandige Zonder Personeel), que exige un plan de negocio evaluado por puntos y unos ingresos orientativos de entre 1.500 y 2.500 €/mes o más; concede una residencia inicial de hasta 2 años, renovable.\n\nEn materia fiscal, quien reside más de 183 días al año en los Países Bajos pasa a tributar por su renta mundial bajo un sistema progresivo que alcanza el 49,5% en los tramos más altos, uno de los más elevados de Europa.", "sources": [{ "label": "Netherlands Digital Nomad Visa – Citizen Remote", "url": "https://citizenremote.com/visas/netherlands/" }] },
    "sanidad": { "content": "Todo residente en los Países Bajos está obligado por ley a contratar un seguro médico básico (basisverzekering) con una aseguradora holandesa, con un coste de unos 120-150 €/mes.\n\nEl hospital de referencia es el Erasmus MC, uno de los centros médicos universitarios más grandes y prestigiosos de Europa; también destacan el Maasstad Ziekenhuis y el Franciscus Gasthuis. La calidad asistencial es de las más altas del continente.", "sources": [{ "label": "Healthcare in Rotterdam – Expat Arrivals", "url": "https://www.expatarrivals.com/europe/netherlands/rotterdam/healthcare-rotterdam" }] },
    "barrios": { "content": "1. **Delfshaven** — barrio con canales históricos y ambiente internacional, popular entre jóvenes expatriados.\n2. **Centrum** — el corazón de la ciudad, con el Markthal y las Cube Houses, alquileres altos pero máxima vida urbana.\n3. **Kralingen** — zona bien conectada junto a un lago y un parque, cerca de la Universidad Erasmus.\n4. **Rotterdam Noord** — barrio en transformación, alternativo y más asequible que el centro.\n\nEl ecosistema de coworking es amplio, con espacios como Spaces y The Student Hotel repartidos por varios barrios.", "sources": [{ "label": "Where to live in Rotterdam – DutchReview", "url": "https://dutchreview.com/expat/housing/where-to-live-in-rotterdam-guide-neighborhoods-of-rotterdam/" }] },
  },
  "puerto-vallarta": {
    "visaFiscal": { "content": "Un ciudadano español puede entrar en México sin visado como turista hasta 180 días, tiempo más que suficiente para la mayoría de estancias de nómada digital sin necesidad de ningún trámite adicional.\n\nPara quedarse más tiempo, México ofrece la Visa de Residente Temporal, que exige acreditar ingresos mensuales de entre 2.500 y 4.000 $/mes (o ahorros de 40.000-70.000 $) durante los últimos 6-12 meses. Concede una estancia inicial de 1 año, ampliable hasta un total de 4 años, sin exigir un mínimo de días de presencia en el país.\n\nEn materia fiscal, superar los 183 días de estancia en México convierte a cualquiera en residente fiscal, con obligación de declarar la renta mundial salvo que se acredite residencia fiscal en otro país.", "sources": [{ "label": "Mexico Digital Nomad Visa – Citizen Remote", "url": "https://citizenremote.com/visas/mexico/" }] },
    "sanidad": { "content": "La red de hospitales privados de Puerto Vallarta es de buen nivel para estándares mexicanos: destacan el Hospital CMQ Premiere, el Hospital San Javier Marina y Amerimed Hospital, todos con personal que suele hablar inglés y acostumbrados a pacientes extranjeros.\n\nUn seguro de salud internacional es muy recomendable, ya que la atención pública mexicana no está pensada para extranjeros sin residencia formal; los precios privados, aun así, son notablemente más bajos que en EE. UU.", "sources": [{ "label": "Healthcare in Puerto Vallarta – Puerto Vallarta Net", "url": "https://www.puertovallarta.net/fast-facts/puerto-vallarta-hospitals-tips/" }] },
    "barrios": { "content": "1. **Zona Romántica** — el corazón turístico y de nómadas, con restaurantes, cafés con wifi y acceso directo a la playa.\n2. **Versalles** — barrio algo más tranquilo, cerca de buenos restaurantes, con ambiente menos turístico.\n3. **Cerca del Estadio Municipal** — opción más económica que la Zona Romántica sin perder cercanía al centro.\n4. **Agua Azul** — algo alejado de la playa, pero a corta distancia a pie o en coche del centro.\n\nVallarta Cowork es el espacio de coworking de referencia, con Cowork Natureza como alternativa más nueva; la comunidad nómada es más pequeña que en Playa del Carmen, lo que facilita hacer contactos.", "sources": [{ "label": "Digital Nomad Guide to Puerto Vallarta – Have WiFi Will Travel", "url": "https://www.havewifiwilltravel.com/nomad-guides/2019/9/8/digitalnomad-puerto-vallarta" }] },
  },
  "tel-aviv": {
    "visaFiscal": { "content": "Un ciudadano español puede entrar en Israel sin visado como turista hasta 90 días dentro de un período de 180, aunque desde 2023 es obligatorio tramitar antes del viaje la autorización electrónica ETA-IL, sin coste y en pocos minutos. No existe ningún visado de nómada digital israelí, así que trabajar remotamente durante la estancia turística se hace en una zona gris sin cobertura laboral.\n\nEl contexto de seguridad regional es un factor a vigilar de forma activa antes y durante cualquier viaje, consultando las recomendaciones oficiales del Ministerio de Asuntos Exteriores antes de reservar.\n\nA efectos fiscales, superar los 183 días de presencia en Israel en un año (o cumplir otros criterios de vínculo económico) puede convertir a alguien en residente fiscal israelí, con obligación de declarar la renta mundial.", "sources": [{ "label": "Israel entry requirements 2026 – Welcome Israel", "url": "https://welcome-israel.com/blog/israel-entry-requirements" }] },
    "sanidad": { "content": "Tel Aviv cuenta con algunos de los hospitales más avanzados de Oriente Medio: el Ichilov (Tel Aviv Sourasky Medical Center) y el Assuta Medical Center son referencia tanto para residentes como para turismo médico internacional, con personal habituado a pacientes extranjeros.\n\nUn seguro médico internacional es imprescindible, ya que la sanidad pública israelí exige estar afiliado al sistema Kupat Holim, algo poco accesible sin residencia formal; la atención privada, aunque de gran calidad, tiene precios elevados para estándares regionales.", "sources": [{ "label": "Tel Aviv Sourasky Medical Center (Ichilov)", "url": "https://www.tasmc.org.il/en/" }] },
    "barrios": { "content": "1. **Rothschild Boulevard** — el bulevar más animado, con cafés con wifi, arquitectura Bauhaus y vida nocturna intensa.\n2. **Florentin** — alternativo y algo más asequible, con ambiente bohemio y estudios desde unos 800 $/mes.\n3. **Neve Tzedek** — el barrio más pintoresco y cultural, aunque con alquileres muy elevados.\n4. **Jaffa** — la zona más económica, con encanto histórico y ambiente multicultural junto al mar.\n\nEntre los coworkings destacan WeWork Sarona, Mindspace en Rothschild y el Google Campus en la Electra Tower, muy orientado a la comunidad de startups.", "sources": [{ "label": "Digital Nomad Guide to Tel Aviv – P.S. I'm On My Way", "url": "https://www.psimonmyway.com/living-in-tel-aviv-digital-nomad-israel/" }] },
  },
  "tanger": {
    "visaFiscal": { "content": "Un ciudadano español puede entrar en Marruecos sin visado como turista hasta 90 días, sin necesidad de ningún trámite previo más allá de un pasaporte válido por al menos 6 meses. No existe visado de nómada digital marroquí, por lo que el trabajo remoto durante la estancia turística no está regulado de forma explícita.\n\nPara estancias más largas, Marruecos ofrece un permiso de residencia (Carte de Séjour) que exige justificar medios de vida suficientes y, en general, requiere gestionarlo tras la llegada al país.\n\nA efectos fiscales, superar los 183 días de presencia en Marruecos puede generar obligaciones de residencia fiscal, aunque en la práctica la aplicación a nómadas digitales extranjeros es poco desarrollada.", "sources": [{ "label": "Morocco Visa for Spanish Citizens – e-Visa Morocco", "url": "https://e-visamorocco.com/blog/morocco-visa-for-spanish-citizens/" }] },
    "sanidad": { "content": "La sanidad privada en Tánger es más limitada que en Casablanca o Rabat, aunque cuenta con centros de referencia como la Clínica Al Kindy y la Clínica Assalam, con especialistas formados en Francia o España en muchos casos.\n\nUn seguro médico internacional es muy recomendable, ya que la sanidad pública marroquí no está pensada para extranjeros y los casos complejos suelen derivarse a Rabat o Casablanca.", "sources": [{ "label": "Morocco Digital Nomad Guide – CityTours Morocco", "url": "https://citytoursmorocco.com/morocco-digital-nomad-guide" }] },
    "barrios": { "content": "1. **Playa** — zona junto al mar con edificios modernos y buena presencia de comercios; se habla inglés y español con facilidad.\n2. **Boulevard** — el centro de la ciudad, céntrico y con buenos servicios, aunque más ruidoso.\n3. **La Kasbah** — el barrio de la medina histórica, con encanto tradicional y precios bajos, aunque poco inglés.\n4. **Boukhalef** — la opción más económica, popular entre estudiantes, cerca del aeropuerto.\n\nLa oferta de coworking es aún reducida: Alpha Coworking es de las opciones más nuevas, con fibra hasta 200 Mbps; muchos nómadas también trabajan desde cafés con wifi del centro.", "sources": [{ "label": "Tangier Digital Nomad Guide – Digital Nomad World", "url": "https://digitalnomads.world/city-guide/tangier/" }] },
  },
  "cuenca": {
    "visaFiscal": { "content": "Un ciudadano español puede entrar en Ecuador sin visado como turista hasta 90 días, ampliables. Ecuador ofrece además un visado de nómada digital (visa de Rentista/Digital Nomad) que exige acreditar ingresos de al menos 1.275 $/mes durante los tres meses previos, seguro médico vigente y certificado de antecedentes penales; concede una estancia inicial de hasta 2 años, renovable por otros 2.\n\nEl trámite tiene un coste aproximado de 450 $ entre tasas de solicitud y de visado, y suele resolverse en 2-4 meses.\n\nA efectos fiscales, superar los 183 días de presencia en Ecuador convierte a alguien en residente fiscal, con obligación de declarar la renta mundial salvo que se acredite residencia fiscal en otro país.", "sources": [{ "label": "Ecuador Digital Nomad Visa – Citizen Remote", "url": "https://citizenremote.com/visas/ecuador-digital-nomad-visa/" }] },
    "sanidad": { "content": "Cuenca cuenta con una sanidad privada de buen nivel para la región, con centros como el Hospital Monte Sinaí y la Clínica Santa Inés, habituados a la numerosa comunidad de jubilados extranjeros de la ciudad.\n\nUn seguro médico internacional sigue siendo recomendable para procedimientos complejos, aunque los precios privados en Cuenca están entre los más bajos de todo el catálogo de Roavio.", "sources": [{ "label": "Cuenca Ecuador Expat Guide 2026 – Vidala", "url": "https://vidala.co/guides/ecuador-cuenca-expat-guide/" }] },
    "barrios": { "content": "1. **El Centro** — el casco histórico colonial, caminable y con la mayor concentración de cafés y vida cultural.\n2. **Gringolandia (Av. Ordóñez Lasso)** — la zona con mayor concentración de expatriados norteamericanos y europeos, con servicios orientados a extranjeros.\n3. **San Sebastián** — céntrico y tranquilo, con buena mezcla de locales y expatriados.\n4. **El Vergel** — residencial y algo más económico, a poca distancia del centro.\n\nLa oferta de coworking formal es limitada; la mayoría de nómadas trabaja desde cafés del centro histórico o desde casa, dado el bajo coste de los alquileres con buena conexión.", "sources": [{ "label": "Cuenca Ecuador Neighborhood Guide – Amelia & JP", "url": "https://ameliaandjp.com/cuenca-ecuador-neighborhoods/" }] },
  },
  "edimburgo": {
    "visaFiscal": { "content": "Un ciudadano español puede entrar en el Reino Unido sin visado como visitante hasta 6 meses, sin derecho a trabajar para una empresa británica ni de forma autónoma en el país. Desde 2025, además, es obligatorio tramitar antes del viaje la autorización electrónica ETA británica, de bajo coste y rápida resolución.\n\nEl Reino Unido no ofrece ningún visado específico de nómada digital, por lo que trabajar remotamente para un empleador extranjero durante la estancia de visitante se mueve en una zona gris tolerada pero no explícitamente regulada.\n\nPara estancias de trabajo formal se necesita un visado de trabajo tradicional (Skilled Worker, Global Talent), con requisitos de patrocinador y salario mínimo específicos.", "sources": [{ "label": "UK ETA Requirements for EU Citizens 2026", "url": "https://etavisauk.org/en/uk-eta-eu-citizens-2026-guide/" }] },
    "sanidad": { "content": "Edimburgo cuenta con una sanidad pública (NHS Scotland) de buen nivel, aunque el acceso completo requiere registro y, en la práctica, cierto tiempo de residencia; el Royal Infirmary of Edinburgh es el hospital de referencia de la ciudad.\n\nUn seguro médico privado (Bupa, AXA o similar) es recomendable para quien no tenga acceso pleno al NHS, y existen clínicas privadas como el Edinburgh Clinic para consultas más rápidas.", "sources": [{ "label": "NHS Lothian – Royal Infirmary of Edinburgh", "url": "https://www.nhslothian.scot/" }] },
    "barrios": { "content": "1. **New Town** — la zona más elegante y práctica para nómadas, con arquitectura georgiana, cafés independientes y buen acceso a coworkings.\n2. **Stockbridge** — ambiente de barrio con encanto local, tiendas independientes y calles más tranquilas.\n3. **Leith** — el puerto de la ciudad, en plena transformación, con coworkings junto al agua y ambiente más relajado que el centro.\n4. **Fountainbridge** — bien conectado y céntrico, con perfil más residencial que las zonas turísticas.\n\nCodeBase, en Castle Terrace, es uno de los mayores hubs tecnológicos de Europa; The Melting Pot y WeWork (George Street, con vistas al castillo) completan la oferta de coworking.", "sources": [{ "label": "Edinburgh for Digital Nomads – WiFi Tribe", "url": "https://wifitribe.co/blog/edinburgh-digital-nomad/" }] },
  },
  "denver": {
    "visaFiscal": { "content": "Al igual que en el resto de Estados Unidos, Denver no ofrece ningún visado de nómada digital. La entrada bajo ESTA permite hasta 90 días de turismo o negocios puntuales, sin autorización para trabajar, y la normativa se fija en dónde se realiza físicamente el trabajo, no en la ubicación del cliente.\n\nPara estancias más largas, las únicas vías reales son los visados de trabajo tradicionales (O-1, L-1, E-2, H-1B), habituales en Denver por su creciente ecosistema tecnológico y de startups.\n\nColorado sí aplica impuesto estatal sobre la renta (tasa fija del 4,4%), a diferencia de estados como Texas o Florida, lo que debe tenerse en cuenta para quien obtenga residencia legal de trabajo allí.", "sources": [{ "label": "Remote Work Visa 2026 – NNU Immigration", "url": "https://www.nnuimmigration.com/remote-work-visa/" }] },
    "sanidad": { "content": "Estados Unidos no tiene sanidad pública universal y los precios sin seguro pueden ser muy altos. Entre los hospitales de referencia en Denver están el UCHealth University of Colorado Hospital, el Presbyterian/St. Luke's Medical Center y el National Jewish Health, especializado en enfermedades respiratorias.\n\nEs imprescindible contratar un seguro médico internacional antes de viajar; sin seguro, una visita a urgencias puede superar fácilmente los 1.000-3.000 $.", "sources": [{ "label": "UCHealth University of Colorado Hospital", "url": "https://www.uchealth.org/locations/uchealth-university-of-colorado-hospital/" }] },
    "barrios": { "content": "1. **RiNo (River North Art District)** — el barrio creativo e industrial reconvertido, con murales, cervecerías y varios coworkings con terraza y vistas a las montañas.\n2. **LoDo (Lower Downtown)** — el centro histórico junto a Union Station, con la mayor concentración de coworkings de la ciudad.\n3. **LoHi (Lower Highlands)** — residencial y de moda, con buenos restaurantes y ambiente más tranquilo que el centro.\n4. **Cherry Creek** — la zona más elitista, con coworkings de gama alta y comercio de lujo.\n\nEntre los coworkings destacan Venture X Denver LoDo, Enterprise Coworking e INDUSTRY RiNo Station, este último combinado con restaurantes y cafés.", "sources": [{ "label": "Best Coworking Spaces in Denver – DropDesk", "url": "https://drop-desk.com/blog/best/coworking-spaces-denver/" }] },
  },
  "santiago": {
    "visaFiscal": { "content": "Un ciudadano español puede entrar en Chile sin visado como turista hasta 90 días, ampliables. Chile ofrece además una Visa de Trabajo a Distancia (Tech Visa) pensada para nómadas digitales, que exige acreditar ingresos de fuente extranjera y un contrato o actividad como freelancer, concediendo una estancia inicial de hasta 1 año.\n\nEn materia fiscal, superar los 183 días de presencia en Chile en un periodo de 12 meses activa la residencia fiscal, con obligación de declarar la renta mundial salvo que se acredite residencia fiscal en otro país.", "sources": [{ "label": "Chile Digital Nomad Visa – Citizen Remote", "url": "https://citizenremote.com/visas/chile/" }] },
    "sanidad": { "content": "Santiago cuenta con una de las mejores sanidades privadas de Sudamérica, con centros de referencia como la Clínica Las Condes y la Clínica Alemana, ambos con atención en inglés y estándares internacionales.\n\nUn seguro médico internacional es muy recomendable, ya que el acceso a la sanidad pública (Fonasa) está pensado para residentes cotizantes, no para visitantes de paso.", "sources": [{ "label": "Clínica Las Condes – About", "url": "https://www.clinicalascondes.cl/" }] },
    "barrios": { "content": "1. **Providencia** — céntrico, seguro y con gran oferta de cafés con wifi y coworkings.\n2. **Las Condes** — el distrito financiero y más exclusivo, con excelente infraestructura.\n3. **Bellavista** — bohemio y con gran vida nocturna, junto al cerro San Cristóbal.\n4. **Ñuñoa** — residencial y universitario, con buen ambiente joven y precios más asequibles.\n\nEntre los coworkings destacan WeWork (varias sedes en Las Condes y Providencia), Co-Work Latam y Urban Station, con fuerte presencia de comunidad tech.", "sources": [{ "label": "WeWork Chile", "url": "https://www.wework.com/en-GB/l/coworking-space/chile" }] },
  },
  "vancouver": {
    "visaFiscal": { "content": "Igual que en el resto de Canadá, un ciudadano español puede entrar en Vancouver sin visado como visitante hasta 6 meses con la autorización electrónica eTA, y trabajar remotamente para un empleador extranjero durante esa estancia sin necesidad de permiso de trabajo, según la aclaración de IRCC de 2023, siempre sin prestar servicio a clientes canadienses.\n\nNo existe un visado de nómada digital específico. Para estancias de trabajo formal se necesita un permiso de trabajo tradicional, generalmente vinculado a una oferta de empleo canadiense.", "sources": [{ "label": "Working remotely from Canada – IRCC (oficial)", "url": "https://www.canada.ca/en/immigration-refugees-citizenship/services/work-canada/permit/temporary/remote-work.html" }] },
    "sanidad": { "content": "El sistema público (MSP en Columbia Británica) no cubre a visitantes extranjeros, por lo que un seguro médico internacional es imprescindible. Entre los hospitales de referencia en Vancouver están el Vancouver General Hospital y el St. Paul's Hospital, ambos de primer nivel.\n\nLos precios sin seguro son elevados, similares a los del resto de Canadá: una visita a urgencias puede superar fácilmente los 1.000-2.000 CAD.", "sources": [{ "label": "Vancouver General Hospital – Vancouver Coastal Health", "url": "https://www.vch.ca/en/location/vancouver-general-hospital" }] },
    "barrios": { "content": "1. **Gastown/Yaletown** — el centro histórico y de negocios reconvertido, con gran oferta de coworkings.\n2. **Mount Pleasant** — creativo y en auge, con cervecerías artesanales y ambiente joven.\n3. **Kitsilano** — junto a la playa, ambiente relajado y orientado al aire libre.\n4. **Commercial Drive** — multicultural y bohemio, con buena vida de barrio.\n\nEntre los coworkings destacan WeWork (varias sedes), Spaces y The Profile, con fuerte presencia de comunidad tech en Gastown y Yaletown.", "sources": [{ "label": "WeWork Vancouver", "url": "https://www.wework.com/en-GB/l/coworking-space/vancouver--bc--canada" }] },
  },
  "lima": {
    "visaFiscal": { "content": "Un ciudadano español puede entrar en Perú sin visado como turista hasta 183 días al año. Perú no cuenta con un visado de nómada digital específico, por lo que trabajar remotamente para un empleador extranjero durante la estancia turística se mueve en una zona gris no explícitamente regulada.\n\nPara estancias más largas, la vía formal es la residencia temporal por rentista o por inversión, con requisitos de ingresos o capital acreditado. En materia fiscal, superar los 183 días de presencia en Perú activa la residencia fiscal, con obligación de declarar la renta mundial.", "sources": [{ "label": "Peru Visa Requirements for Spanish Citizens – Visa List", "url": "https://visalist.io/peru/visa-requirements/spain" }] },
    "sanidad": { "content": "Entre los centros privados de referencia en Lima están la Clínica Anglo Americana, con atención en inglés y estándares internacionales, y la Clínica Ricardo Palma, ambas muy usadas por la comunidad expatriada.\n\nUn seguro médico internacional es muy recomendable, ya que el sistema público peruano no está pensado para extranjeros sin residencia formal.", "sources": [{ "label": "Clínica Anglo Americana – About", "url": "https://www.clinicangloamericana.pe/" }] },
    "barrios": { "content": "1. **Miraflores** — el barrio más turístico y seguro, junto al malecón del Pacífico, con la mayor oferta de cafés con wifi.\n2. **Barranco** — bohemio y artístico, con gran vida nocturna y ambiente creativo.\n3. **San Isidro** — el distrito financiero, elegante y con buena infraestructura.\n\nEntre los coworkings destacan WeWork (San Isidro y Miraflores), Co-Work Perú y Urban Station, con fuerte presencia de comunidad internacional.", "sources": [{ "label": "WeWork Peru", "url": "https://www.wework.com/en-GB/l/coworking-space/lima--peru" }] },
  },
  "marrakech": {
    "visaFiscal": { "content": "Un ciudadano español puede entrar en Marruecos sin visado como turista hasta 90 días, sin necesidad de ningún trámite previo más allá de un pasaporte válido por al menos 6 meses. No existe visado de nómada digital marroquí, por lo que el trabajo remoto durante la estancia turística no está regulado de forma explícita.\n\nPara estancias más largas, Marruecos ofrece la Carte de Séjour, concedida inicialmente por 1 año y renovable, que exige demostrar recursos económicos suficientes y estables, sin un umbral mínimo de ingresos fijado explícitamente.", "sources": [{ "label": "Morocco Digital Nomad Visa 2026 – Citizen Remote", "url": "https://citizenremote.com/visas/morocco-digital-nomad-visa/" }] },
    "sanidad": { "content": "Entre los centros privados de referencia en Marrakech están la Clinique Internationale de Marrakech y la Clinique Menara, ambas con buena reputación entre la comunidad expatriada.\n\nUn seguro internacional (SafetyWing, Cigna Global) es muy recomendable: la sanidad privada marroquí tiene precios bajos comparada con Europa, pero los hospitales privados de nivel internacional suelen exigir depósito o prueba de cobertura al ingresar.", "sources": [{ "label": "Clinique Internationale de Marrakech", "url": "https://www.cim.ma/" }] },
    "barrios": { "content": "1. **Gueliz** — el barrio moderno y de negocios, con la mayor concentración de cafés con wifi y coworkings.\n2. **Medina** — el casco histórico Patrimonio de la UNESCO, con riads y ambiente tradicional.\n3. **Hivernage** — elegante y tranquilo, junto a los principales hoteles de lujo.\n\nEntre los coworkings destacan Mademoiselle Coworking y La Fabrique Marrakech, concentrados sobre todo en Gueliz.", "sources": [{ "label": "Mademoiselle Coworking Marrakech", "url": "https://www.mademoisellecoworking.com/" }] },
  },
  "cebu": {
    "visaFiscal": { "content": "Un ciudadano español puede entrar en Filipinas sin visado como turista hasta 30 días, ampliables por otros 59 en oficinas de inmigración locales. Filipinas aprobó en 2025 un visado de nómada digital que exige acreditar ingresos generados fuera del país (cifras no oficiales apuntan a unos 24.000 $/año), seguro médico vigente y antecedentes penales limpios, con una validez inicial de hasta 1 año renovable por otro igual.\n\nA efectos fiscales, Filipinas solo grava a los no residentes por la renta de fuente local, por lo que los ingresos remotos cobrados desde el extranjero no suelen tributar allí, aunque conviene confirmar la situación con un asesor si la estancia se prolonga.", "sources": [{ "label": "Philippines Digital Nomad Visa – Citizen Remote", "url": "https://citizenremote.com/visas/philippines-digital-nomad-visa/" }] },
    "sanidad": { "content": "Cebu cuenta con hospitales privados de buen nivel para la región, con el Chong Hua Hospital y el Cebu Doctors' University Hospital como referencia, ambos con personal acostumbrado a pacientes internacionales.\n\nUn seguro médico internacional es muy recomendable: aunque los precios privados en Cebu son bajos comparados con Europa, los hospitales de mejor nivel suelen exigir depósito o prueba de cobertura al ingresar.", "sources": [{ "label": "Chong Hua Hospital – Sitio oficial", "url": "https://chonghua.com.ph/" }] },
    "barrios": { "content": "1. **IT Park** — el distrito de negocios 24 horas, con la mayor concentración de coworkings, cafés y vida nocturna; el más caro pero el más práctico para nómadas.\n2. **Lahug** — residencial y tranquilo, en zona elevada con vistas y brisa más fresca, cerca de IT Park.\n3. **Cebu Business Park (Ayala)** — el distrito financiero, con centros comerciales premium y calles arboladas.\n4. **Mactan** — la isla junto a Cebu, con playas, resorts y buceo, conectada por puente; ambiente de vacación permanente.\n\nLa oferta de coworking se concentra en IT Park, con espacios como el propio distrito ofreciendo fibra rápida y comunidad internacional activa.", "sources": [{ "label": "Best Areas to Live in Cebu – 3D Universal", "url": "https://3d-universal.com/en/blogs/best-areas-to-live-in-cebu-top-10-neighborhoods-for-expats.html" }] },
  },
  "antigua-guatemala": {
    "visaFiscal": { "content": "Un ciudadano español puede entrar en Guatemala sin visado como turista hasta 90 días. Guatemala aprobó en octubre de 2025 una residencia de nómada digital (Acuerdo IGM-016-2025) que exige acreditar ingresos de fuente extranjera de al menos 2.000 $/mes (3.000 $ con dependientes), seguro médico internacional y antecedentes penales apostillados, con un coste total aproximado de 300-450 $ el primer año.\n\nA efectos fiscales, Guatemala aplica un sistema territorial: solo se grava la renta de fuente guatemalteca, por lo que los ingresos remotos cobrados desde el extranjero no suelen tributar allí, aunque el estatus legal del trabajo físico realizado en el país sigue siendo ambiguo.", "sources": [{ "label": "Guatemala Digital Nomad Visa – Living in Guatemala", "url": "https://livinginguatemala.com/tramites/igm-residencia-nomada-digital/" }] },
    "sanidad": { "content": "Antigua cuenta con el Hospital Privado Hermano Pedro como referencia local, aunque para casos complejos muchos expatriados prefieren desplazarse a la cercana Ciudad de Guatemala, con hospitales de mayor nivel.\n\nUn seguro médico internacional es imprescindible, ya que la sanidad pública guatemalteca no está pensada para extranjeros y la privada de mayor nivel se concentra en la capital, a unos 45 minutos.", "sources": [{ "label": "Hospital Privado Hermano Pedro – Vida Antigua", "url": "https://www.vidaantigua.com/healthcare/hospital-privado-hermano-pedro/" }] },
    "barrios": { "content": "1. **Centro (cerca de La Merced y Parque Central)** — la zona más caminable, con la mayor concentración de cafés, restaurantes y vida cultural; toda la ciudad se cruza en unos 20 minutos a pie.\n2. **Alrededores de Parque Central** — el corazón cívico de la ciudad, con acceso directo a los principales sitios históricos.\n\nAl ser una ciudad pequeña, la mayoría de nómadas trabaja desde cafés en vez de coworkings dedicados; Impact Hub (unos 10 $/día) y Selina (unos 8 $/día) son las opciones formales más conocidas.", "sources": [{ "label": "Living in Antigua Guatemala as a Digital Nomad – Bucket List Bri", "url": "https://bucketlistbri.com/living-antigua-guatemala-digital-nomad/" }] },
  },
  "pristina": {
    "visaFiscal": { "content": "Un ciudadano español puede entrar en Kosovo sin visado como turista hasta 90 días dentro de un período de 180. Kosovo no cuenta con ningún visado de nómada digital específico, por lo que trabajar remotamente para un empleador extranjero durante la estancia turística se mueve en una zona gris no explícitamente regulada.\n\nA efectos fiscales, superar los 183 días de presencia en Kosovo puede generar obligaciones de residencia fiscal según la normativa general de la región, aunque en la práctica la aplicación a nómadas digitales extranjeros está poco desarrollada y conviene confirmar la situación con un asesor.", "sources": [{ "label": "Kosovo Visa & Entry Requirements 2026", "url": "https://thingstodoinkosovo.com/entry-requirements/" }] },
    "sanidad": { "content": "Pristina cuenta con el American Hospital, el centro privado de referencia para expatriados, con estándares internacionales y personal que habla inglés.\n\nUn seguro médico internacional sigue siendo recomendable para procedimientos complejos, aunque los precios de la sanidad privada en Pristina están entre los más bajos de Europa.", "sources": [{ "label": "American Hospital Pristina – Sitio oficial", "url": "https://ks.spitaliamerikan.com/en/about-us/" }] },
    "barrios": { "content": "1. **Dragodan/Arbëria** — el barrio residencial más elegante, con vistas panorámicas de la ciudad y buena oferta de restaurantes.\n2. **Pejton** — tranquilo y a solo 5 minutos a pie del centro, con cafés y hostels alejados del bullicio principal.\n3. **Dardania** — residencial y bien conectado, entre la estación de autobuses y el centro.\n4. **Sunny Hill (Kodra e Diellit)** — zona en expansión, algo alejada del centro pero con precios más asequibles.\n\nLa escena de cafés con wifi crece cada año en el centro y en Pejton, aunque la oferta de coworking formal todavía es limitada comparada con otras capitales balcánicas.", "sources": [{ "label": "Pristina – Wikivoyage", "url": "https://en.wikivoyage.org/wiki/Pristina" }] },
  },
  "kampala": {
    "visaFiscal": { "content": "Un ciudadano español necesita visado para entrar en Uganda, ya que España no está en la lista de países exentos; el trámite se realiza online mediante e-visa, exige pasaporte válido, foto reciente y certificado de fiebre amarilla obligatorio para todos los viajeros. Uganda no cuenta con ningún visado de nómada digital específico.\n\nA efectos fiscales, superar los 183 días de presencia en Uganda puede generar obligaciones de residencia fiscal según la normativa general, aunque en la práctica la aplicación a nómadas digitales extranjeros está poco desarrollada.", "sources": [{ "label": "Uganda eVisa for Spanish Citizens", "url": "https://uganda-evisa.com/uganda-evisa-for-spain-citizens/" }] },
    "sanidad": { "content": "Kampala cuenta con el International Hospital Kampala (IHK) como referencia para expatriados, con estándares más altos que la media regional y personal acostumbrado a pacientes internacionales; Case Medical Centre es otra opción privada reconocida.\n\nUn seguro médico internacional es imprescindible, ya que los casos complejos suelen requerir evacuación médica a Nairobi o Europa, y la vacuna de la fiebre amarilla es obligatoria antes de viajar.", "sources": [{ "label": "International Hospital Kampala – Wikipedia", "url": "https://en.wikipedia.org/wiki/International_Hospital_Kampala" }] },
    "barrios": { "content": "1. **Kololo** — el barrio diplomático y más elegante, con calles arboladas, embajadas y restauración de nivel.\n2. **Bugolobi** — residencial y tranquilo, popular entre expatriados, con cafés y ambiente relajado.\n3. **Muyenga (Tank Hill)** — zona elevada con vistas impresionantes sobre la ciudad y el lago Victoria, oferta creciente de bares y restaurantes.\n4. **Nakasero** — el centro comercial e histórico, más bullicioso pero muy céntrico.\n\nLa oferta de coworking formal es aún reducida; la mayoría de nómadas trabaja desde cafés en Kololo y Bugolobi o desde casa, dado el coste elevado del internet fijo de mayor calidad.", "sources": [{ "label": "Kampala Neighbourhood Guide – Amazing Gorilla Safaris", "url": "https://www.amazinggorillasafaris.com/adventures/kampala-neighbourhood-guide-the-best-areas-to-eat-stay-explore/" }] },
  },
  "da-lat": {
    "visaFiscal": { "content": "Un ciudadano español puede entrar en Vietnam mediante el e-visa online, disponible para todas las nacionalidades: la opción de entrada múltiple de 90 días cuesta 50 $ y tarda 3-5 días hábiles en tramitarse, frente a los 25 $ de la opción de entrada única. Vietnam no cuenta con ningún visado de nómada digital específico.\n\nA efectos fiscales, superar los 183 días de presencia en Vietnam en un año natural puede generar obligaciones de residencia fiscal, por lo que conviene consultar con un asesor tanto la normativa vietnamita como la española antes de estancias largas.", "sources": [{ "label": "Vietnam E-Visa for Digital Nomads 2026", "url": "https://evisasvietnam.com/blog/vietnam-e-visa-for-remote-workers-digital-nomads-2026/" }] },
    "sanidad": { "content": "Da Lat cuenta con el Lam Dong General Hospital como principal centro público y el Hoan My Da Lat Hospital como opción privada, aunque para procedimientos complejos muchos expatriados se desplazan a Ho Chi Minh, a poco más de una hora en avión.\n\nUn seguro médico internacional con cobertura de evacuación es muy recomendable, dada la limitada capacidad de atención especializada de la ciudad frente a los grandes hubs vietnamitas.", "sources": [{ "label": "Hoan My Da Lat Hospital", "url": "https://hoanmy.com/en/da-lat/" }] },
    "barrios": { "content": "1. **Centro (lago Xuan Huong)** — el corazón de la ciudad, con arquitectura de herencia francesa, mercados y cafés a poca distancia; la zona más práctica aunque también la más turística.\n2. **Phường 3** — residencial y tranquilo al norte del centro, popular entre nómadas de larga estancia por precios más bajos y ambiente local auténtico.\n3. **Valle del Amor** — entorno natural con pinares y jardines, más fresco que el centro pero requiere moto para moverse.\n\nLa oferta de cafés-coworking crece cada año en el centro y Phường 3, con buena velocidad de internet gracias a la infraestructura vietnamita, aunque las zonas más alejadas hacia el lago Tuyen Lam pueden tener conexión menos fiable.", "sources": [{ "label": "Best Neighborhoods in Da Lat – Geronimo AI", "url": "https://geronimo-ai.com/best-neighborhoods/da-lat" }] },
  },
  "hanoi": {
    "visaFiscal": { "content": "Un ciudadano español puede entrar actualmente en Vietnam sin visado hasta 45 días como turista (esta exención se ha ido ampliando repetidamente por decreto gubernamental, así que conviene comprobarlo justo antes de viajar). Para estancias más largas, el e-visa permite hasta 90 días, de entrada única o múltiple, cuesta entre 25 y 50 $ a través del portal oficial y se tramita en 3-7 días hábiles; la Embajada de Vietnam en Madrid también gestiona solicitudes directamente.\n\nVietnam no cuenta con ningún visado de nómada digital específico en 2026. Se propuso una \"Golden Visa\" (hasta 10 años) en abril de 2025, pero sigue en fase de propuesta, y en agosto de 2025 se lanzó un visado de talento de 5 años dirigido a profesionales cualificados, no a nómadas remotos en general. En la práctica, la mayoría recurre a e-visas renovables de 90 días.\n\nA efectos fiscales, España y Vietnam firmaron un convenio de doble imposición en 2005 (en vigor desde 2006, que cubre el impuesto sobre la renta pero no el patrimonio). La regla de los 183 días de España se aplica igualmente de forma independiente: superar ese umbral en España en un año natural (o mantener ahí el centro de intereses económicos) mantiene la residencia fiscal española con independencia del tiempo pasado en Vietnam.", "sources": [{ "label": "Requisitos de visado para ciudadanos españoles – MyVietnamVisa", "url": "https://www.myvietnamvisa.com/visa-requirements/spain.html" }, { "label": "Estado del visado de nómada digital de Vietnam – The Digital Nomad Asia", "url": "https://www.thedigitalnomad.asia/digital-nomad-visa/vietnam-digital-nomad-visa/" }, { "label": "Convenio de doble imposición España-Vietnam – BOE", "url": "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2006-278" }] },
    "sanidad": { "content": "Entre los hospitales privados de referencia están el Vinmec Times City International Hospital (gran centro multidisciplinar orientado también al turismo médico), el Hanoi French Hospital, el Hong Ngoc General Hospital y el Thu Cuc International General Hospital; Family Medical Practice y Raffles Medical Hanoi son buenas clínicas internacionales para primeras valoraciones. Vinmec y FV Hospital pueden facturar directamente a muchos aseguradores internacionales, mientras que las clínicas más pequeñas suelen exigir pago por adelantado.\n\nUna consulta con médico general cuesta entre 800.000 y 1.500.000 VND (unos 32-60 $) en hospitales privados de gama media, o entre 1,5 y 3 millones VND (60-120 $) en centros de estándar internacional. El seguro Nomad Insurance de SafetyWing ronda los 56 $/mes para menores de 40 años. Ninguna vacuna es obligatoria para entrar, aunque se recomiendan tifoidea, hepatitis A/B, refuerzo de polio, encefalitis japonesa y rabia para estancias largas.", "sources": [{ "label": "Hospitales en Hanoi para extranjeros – VietnamClinic", "url": "https://vietnamclinic.com/hospitals-hanoi" }, { "label": "Comparativa de costes sanitarios – VietnamKB", "url": "https://vietnamkb.com/living-in-vietnam/healthcare-cost-comparison" }] },
    "barrios": { "content": "1. **Tay Ho (Lago del Oeste)** — tranquilo, elegante y con vistas, la base nómada más popular de Hanoi, desde unos 500 $/mes.\n2. **Hoan Kiem (Casco Antiguo)** — céntrico y vibrante, ideal para vivir cerca de los principales puntos de interés, desde unos 400 $/mes.\n3. **Ba Dinh** — tranquilo, acomodado y céntrico, desde unos 400 $/mes.\n4. **Cau Giay** — tranquilo y elegante, cerca del centro, desde unos 400 $/mes.\n\nToong (varias sedes) cobra unos 150.000 VND (6 $) por un pase de día y entre 1 y 1,5 millones VND (40-60 $) al mes por un puesto compartido; UP Coworking en Tay Ho es algo más barato; Hatch! Nest tiene un enfoque fuerte de comunidad startup. La oferta de coworking en Hanoi es menor que en Ho Chi Minh o Da Nang.", "sources": [{ "label": "Barrios de Hanoi para nómadas digitales – GoGaffl", "url": "https://www.gogaffl.com/blog_posts/hanoi-best-neighborhoods-digital-nomads" }, { "label": "Mejores coworkings de Vietnam 2026 – Digital Nomad Guides", "url": "https://digital-nomad-guides.com/blog/best-coworking-spaces-in-vietnam-for-digital-nomads-2026/" }] },
  },
  "shenzhen": {
    "visaFiscal": { "content": "España está en la lista unilateral de exención de visado de China (vigente desde diciembre de 2023 y prorrogada hasta finales de 2026): los pasaportes españoles ordinarios obtienen 30 días sin visado para turismo, negocios y visitas familiares, entrando por cualquiera de los pasos fronterizos de Shenzhen (Futian, Luohu, Shenzhen Bay, Huanggang). El trabajo remunerado no está cubierto por esta exención, y el alojamiento privado debe registrarse ante la policía local en 24 horas.\n\nChina no cuenta con ningún visado de nómada digital, así que quienes trabajan en remoto dependen actualmente de estas estancias de 30 días sin visado o de visados de negocios/trabajo estándar que exigen patrocinio de un empleador. Trabajar para un empleador extranjero durante una entrada turística sin visado se mueve en una zona gris legal, ya que el trabajo remunerado no figura técnicamente entre los propósitos permitidos.\n\nA efectos fiscales, la regla de los 183 días de España se aplica con independencia de la situación en Shenzhen: dado que el límite de 30 días hace muy improbable una residencia fiscal china real sin un permiso de trabajo, la mayoría de nómadas siguen siendo residentes fiscales españoles y deben declarar su renta mundial en España.", "sources": [{ "label": "Políticas de viaje sin visado de China – China Briefing", "url": "https://www.china-briefing.com/news/china-visa-free-travel-policies-complete-guide/" }, { "label": "Entrada sin visado a Shenzhen – ShenzhenDecoded", "url": "https://www.shenzhendecoded.com/en/guides/visa-free-china" }] },
    "sanidad": { "content": "Entre los hospitales con atención a pacientes internacionales están el University of Hong Kong-Shenzhen Hospital en Futian (la mejor primera opción para atención en inglés), el Shenzhen People's Hospital en Luohu, el Peking University Shenzhen Hospital y el Shenzhen Second People's Hospital. La mayoría ofrece informes traducidos al inglés y, opcionalmente, un acompañante que hable inglés, con precios facilitados caso por caso antes del pago.\n\nNinguna vacuna es obligatoria para entrar salvo llegada desde un país con riesgo de fiebre amarilla. Se recomiendan habitualmente tifoidea, hepatitis A/B, refuerzo de polio, encefalitis japonesa (presente en la mayoría de provincias) y rabia (China se considera de alto riesgo, por lo que se aconseja para estancias largas).", "sources": [{ "label": "Mejores hospitales de Shenzhen para extranjeros – SinoCareLink", "url": "https://sinocarelink.org/blogs/blog/best-hospitals-shenzhen-foreigners" }, { "label": "Vacunas para China – Passport Health", "url": "https://www.passporthealthusa.com/destination-advice/china/" }] },
    "barrios": { "content": "1. **Futian** — el distrito financiero, precios altos, la base más fiable para negocios y conexión de metro.\n2. **Nanshan** — el hub tecnológico de Shenzhen, cerca de sus distritos de innovación, generalmente el mejor equilibrio entre vida y desplazamientos.\n3. **Shekou y Shenzhen Bay** — de nivel más alto y frente al mar, con la mayor densidad de negocios angloparlantes.\n4. **Bao'an y Longgang** — la opción más económica, con un desplazamiento más largo hasta el centro.\n\nHIBC ofrece un puesto compartido desde unos 85 $/mes, y The Executive Centre en la China Resources Tower parte de unos 260 $/mes; WeWork, SimplyWork y ParticleX también operan varias sedes en Shenzhen.", "sources": [{ "label": "Mejores barrios para expatriados en Shenzhen – SimpleStayChina", "url": "https://simplestaychina.com/guides/best-neighborhoods-for-expats-in-shenzhen" }, { "label": "Espacios de coworking en Shenzhen – Coworkbooking", "url": "https://www.coworkbooking.com/asia/china/shenzhen" }] },
  },
  "abu-dabi": {
    "visaFiscal": { "content": "Como ciudadano de la UE, un español obtiene entrada turística a la llegada a los EAU por una estancia que se cita habitualmente en hasta 90 días (conviene confirmarlo justo antes de viajar con la Embajada de España en Abu Dabi o el portal oficial U.AE, ya que las condiciones exactas pueden cambiar). Para estancias más largas, el Remote Work Visa de Abu Dabi, gestionado por la Abu Dhabi Residents Office (ADRO), permite a trabajadores remotos empleados fuera de los EAU vivir en la ciudad durante 1 año, renovable anualmente.\n\nLos requisitos incluyen unos ingresos mensuales mínimos de 3.500 $ (acreditados con nóminas y 6 meses de extractos bancarios) y un seguro médico de residencia a largo plazo obligatorio —el seguro de viaje no es válido—, con un coste aproximado de 500 a 2.500 $/año. El trámite tarda unos 5-7 días hábiles una vez presentada la solicitud completa, y el coste total del primer año, incluyendo tasa de solicitud, prueba médica, Emirates ID y seguro, suele rondar entre 1.400 y 2.000 $.\n\nEspaña y los EAU firmaron un convenio de doble imposición en 2006 (en vigor desde 2007). El 0% de impuesto sobre la renta de los EAU no implica automáticamente un 0% de impuestos en España: la residencia fiscal española se determina de forma independiente según el criterio de los 183 días o el centro de intereses económicos, así que quien no establezca de verdad una residencia fiscal en los EAU (183+ días más un certificado de residencia fiscal emiratí) puede seguir tributando en España por su renta mundial, un error muy común y costoso.", "sources": [{ "label": "Remote Work Visa – Abu Dhabi Residents Office (oficial)", "url": "https://www.adro.gov.ae/Visas/Types-of-Visas/RealEstateOwners/Remote-Work-Visa" }, { "label": "Visado de nómada digital de Dubái/EAU – Citizen Remote", "url": "https://citizenremote.com/visas/dubai-digital-nomad-visa/" }, { "label": "Convenio de doble imposición España-EAU – Agencia Tributaria", "url": "https://sede.agenciatributaria.gob.es/Sede/normativa-criterios-interpretativos/fiscalidad-internacional/convenios-doble-imposicion-firmados-espana/emiratos-arabes-unidos.html" }] },
    "sanidad": { "content": "Entre los hospitales privados de referencia están el Cleveland Clinic Abu Dhabi (Al Maryah Island, modelo estadounidense \"Patients First\", cubre a la mayoría de aseguradoras principales), el Burjeel Hospital (acreditación JCI), el NMC Specialty Centre y el Mediclinic Al Noor Hospital, todos con amplia cobertura de especialidades.\n\nUn seguro médico general para expatriados en los EAU ronda los 6.000 AED/año para una persona y 20.000 AED/año para una familia, aunque el propio Remote Work Visa exige una póliza específica de larga duración de unos 500-2.500 $/año. Ninguna vacuna es obligatoria salvo llegada desde un país con riesgo de fiebre amarilla; se recomiendan habitualmente tifoidea, hepatitis A/B y rabia para estancias largas, además de precauciones estándar frente al dengue en zonas urbanas.", "sources": [{ "label": "Mejores hospitales de Abu Dabi – MyBayut", "url": "https://www.bayut.com/mybayut/top-hospitals-abu-dhabi/" }, { "label": "Seguro médico para expatriados en Abu Dabi – Pacific Prime", "url": "https://www.pacificprime.com/blog/abu-dhabi-health-insurance-for-expats.html" }] },
    "barrios": { "content": "1. **Al Reem Island** — comunidad tranquila con energía de distrito financiero, más asequible que Yas o Saadiyat.\n2. **Yas Island** — orientado al entretenimiento (F1, parques temáticos), con estudios desde unos 55.000 AED/año.\n3. **Saadiyat Island** — la opción más cara y cultural (Louvre Abu Dabi), con pisos de una habitación desde 87.000-144.000 AED/año.\n4. **Al Khalidiya** — moderno, cerca de la playa y animado, con estudios desde unos 34.000 AED/año.\n5. **The Corniche** — frente al mar y tranquilo, con estudios desde unos 50.000 AED/año.\n\nServcorp ofrece oficinas desde 1.200+ AED/mes, Regus desde 530-1.370 AED/mes, y Hub71 en Al Maryah Island es el hub de startups insignia respaldado por el gobierno.", "sources": [{ "label": "Guía de Abu Dabi – Digital Nomads World", "url": "https://digitalnomads.world/city-guide/abu-dhabi/" }] },
  },
  "nairobi": {
    "visaFiscal": { "content": "Al no ser España miembro de la Comunidad de África Oriental, los ciudadanos españoles no están exentos de la eTA obligatoria de Kenia: hay que solicitarla online antes de viajar, con una tasa de unos 30-34 $, pasaporte con al menos 6 meses de validez, foto reciente y justificante de alojamiento e itinerario. El trámite tarda normalmente unos 3 días hábiles, y puede solicitarse hasta 3 meses antes.\n\nEl Class N Permit de Kenia, creado por la normativa migratoria de 2024, es la vía de nómada digital del país: exige acreditar ingresos de fuente extranjera (las cifras citadas van desde unos 24.000 $/año en fuentes legales hasta importes mayores citados por agencias de visados, conviene confirmar el umbral vigente antes de solicitar), 3 meses de extractos bancarios o nóminas, y un certificado de antecedentes penales del país de residencia. Tiene una validez de 1 o 2 años, renovable, con una tasa de tramitación de 200 $ más 1.000 $/año aprobado (1.200 $ para un año o 2.200 $ para dos), pagados a través del portal eCitizen, y tarda entre 4 y 8 semanas en resolverse. Quien lo obtiene debe firmar un compromiso de no realizar actividades remuneradas de fuente local.\n\nA efectos fiscales, la regla de los 183 días de España se aplica como siempre, pero hay una diferencia importante respecto a la mayoría de destinos: España y Kenia no tienen convenio de doble imposición, así que quien pase a ser residente fiscal en Kenia se enfrenta a un riesgo real de doble tributación sin más mecanismo de alivio que las reglas unilaterales de deducción por impuestos extranjeros de España.", "sources": [{ "label": "eTA de Kenia – portal oficial", "url": "https://etakenya.go.ke/how-to-apply" }, { "label": "Class N Digital Nomad Permit – Njaga Advocates", "url": "https://njagaadvocates.com/understanding-the-class-n-digital-nomad-permit-in-kenya/" }, { "label": "Países con convenio de doble imposición con España – Agencia Tributaria", "url": "https://sede.agenciatributaria.gob.es/Sede/ayuda/manuales-videos-folletos/manuales-practicos/manual-tributacion-no-residentes/anexos/paises-convenio.html" }] },
    "sanidad": { "content": "Entre los hospitales privados de referencia están el Aga Khan University Hospital, el Nairobi Hospital, el M.P. Shah Hospital, el Karen Hospital y el Gertrude's Children's Hospital para pediatría. El seguro médico privado no es legalmente obligatorio pero se recomienda encarecidamente: una enfermedad grave o una evacuación médica pueden resultar muy costosas sin él, y no todas las pólizas son aceptadas en todos los hospitales, así que conviene comprobar la cobertura antes de una urgencia.\n\nLa profilaxis antipalúdica se recomienda generalmente para zonas por debajo de 2.500 metros, aunque Nairobi se sitúa cerca de ese umbral (unos 1.800 metros) y se considera de menor riesgo que las zonas costeras o del lago; las cepas locales son resistentes a la cloroquina. La fiebre amarilla solo es obligatoria si se llega desde un país con riesgo. Se recomiendan habitualmente tifoidea, hepatitis A/B, refuerzo de polio, rabia para estancias largas y meningitis (especialmente en la temporada seca de diciembre a junio).", "sources": [{ "label": "Sanidad en Nairobi – ExpatArrivals", "url": "https://www.expatarrivals.com/africa/kenya/nairobi/healthcare-nairobi" }, { "label": "Vacunas para Kenia – Passport Health", "url": "https://www.passporthealthusa.com/destination-advice/kenya/" }] },
    "barrios": { "content": "1. **Westlands** — elegante, con la mejor oferta de tiendas, restaurantes y coworkings; los Airbnb suelen partir de 50 $/noche.\n2. **Kilimani** — residencial con buen acceso a servicios, apartamentos amueblados desde unos 26 $/noche, buena opción económica cerca del Yaya Centre.\n3. **Karen, Runda, Gigiri y Muthaiga** — las zonas residenciales más seguras y lujosas, con ambiente de barrio diplomático y precios más altos.\n\nNairobi Garage ofrece un puesto compartido desde unos 15.000 KES/mes y oficina privada desde 75.000 KES/mes con 150 Mbps de internet; iHub, en Ngong Road, es la referencia de la comunidad startup/tecnológica por unos 5.000 KES/mes; Flexidesk es la opción más económica, desde 10.000 KES/mes.", "sources": [{ "label": "Guía de nómada digital para Nairobi – FreakingNomads", "url": "https://freakingnomads.com/digital-nomad-guide-to-nairobi-kenya/" }, { "label": "Mejores coworkings de Nairobi – CreativeKigen", "url": "https://creativekigen.com/best-coworking-spaces-in-nairobi-kenya/" }] },
  },
  "osaka": {
    "visaFiscal": { "content": "España tiene una exención de visado recíproca con Japón, así que un ciudadano español puede entrar sin visado hasta 90 días como turista. Desde marzo de 2024, Japón también ofrece un visado de nómada digital bajo el estatus de \"Actividades Designadas\": tiene una validez máxima de 6 meses, no renovable, y volver a solicitarlo exige salir antes de Japón. Requiere unos ingresos anuales de al menos 10.000.000 JPY (unos 61.000 €), acreditados con certificados fiscales o contratos, y un seguro privado obligatorio que cubra al menos 10 millones JPY (unos 61.000 €) en tratamiento médico. La elegibilidad se limita a ciudadanos de países que tengan a la vez exención de visado con Japón y un convenio fiscal con el país; España cumple ambos requisitos. Cónyuges e hijos pueden incluirse como dependientes. No hay tasa ni plazo oficial de tramitación publicados; estimaciones de despachos privados apuntan a un proceso de unos 8 meses, algo a tener muy en cuenta frente a la corta validez del visado.\n\nA efectos fiscales, Japón generalmente solo considera residente a quien mantiene domicilio en el país durante un año o más, así que alguien con el visado de nómada digital de 6 meses probablemente siga siendo no residente a efectos fiscales japoneses. Eso no cambia las reglas de España: el umbral de los 183 días se aplica de forma independiente, así que la mayoría de usuarios de este visado siguen siendo residentes fiscales españoles y deben declarar su renta mundial en España.", "sources": [{ "label": "Visado de nómada digital – Ministerio de Asuntos Exteriores de Japón (oficial)", "url": "https://www.mofa.go.jp/ca/fna/pagewe_000001_00046.html" }, { "label": "Guía del visado de nómada digital – VisaJapan.jp", "url": "https://english.visajapan.jp/qa/qa_digitalnomad.html" }] },
    "sanidad": { "content": "Entre los hospitales de referencia en Osaka están el Japanese Red Cross Osaka Hospital en Tennoji-ku (urgencias 24 horas con apoyo en inglés), el Osaka University Hospital en Suita (acreditación JMIP para pacientes internacionales) y el Tokiwa Medical Clinic en Abeno-ku, con atención en inglés y horario fuera de horas habituales para residentes extranjeros.\n\nUna consulta médica estándar cuesta entre 70 y 100 $, y una visita a una clínica privada fuera de horario con radiografía o derivación puede llegar a 110-200 $. El plan Essential de SafetyWing ronda los 63 $ cada 4 semanas, y el Complete unos 177,50 $/mes. Entre las vacunas recomendadas están hepatitis A/B, encefalitis japonesa (presente en la mayoría de islas salvo Hokkaido, con mayor riesgo de julio a octubre), refuerzo de polio y rabia para estancias largas.", "sources": [{ "label": "Hospitales en Japón – InternationalInsurance.com", "url": "https://www.internationalinsurance.com/countries/japan/hospitals/" }, { "label": "Vacunas para Japón – Passport Health", "url": "https://www.passporthealthusa.com/destination-advice/japan/" }] },
    "barrios": { "content": "1. **Umeda (Kita Ward)** — el distrito de negocios y transporte más pulido de Osaka, más tranquilo y corporativo, con compras y restauración de nivel.\n2. **Namba y Shinsaibashi (Minami Ward)** — la zona más animada de la ciudad, más joven y creativa, con ambiente de vida nocturna y gastronomía.\n\nThe DECK, en Hommachi, cobra unos 500 ¥ por las dos primeras horas y luego 200 ¥/hora, con una cuota mensual de unos 9.800 ¥ y buena reputación de comunidad. WeWork y Regus/Business Airport operan varias sedes en Osaka, Knowledge Capital cerca de Umeda tiene ambiente de hub de innovación, y Bizcomfort y Coinspace son las opciones más económicas de pago por uso.", "sources": [{ "label": "Guía de coworking y nómadas digitales de Osaka – RoamPads", "url": "https://www.roampads.com/blog/osaka-coworking-digital-nomad-guide" }, { "label": "The DECK – precios oficiales", "url": "https://en.thedeck.jp/coworking-space" }] },
  },
  "auckland": {
    "visaFiscal": { "content": "España está en la lista de exención de visado de Nueva Zelanda, pero un ciudadano español necesita igualmente un NZeTA (Autorización Electrónica de Viaje) antes de volar: 17 NZD a través de la app oficial o 23 NZD online, más una Tasa de Visitante Internacional obligatoria de 100 NZD, un total de unos 117-123 NZD. Cubre estancias turísticas que suelen citarse en hasta 90 días por entrada (conviene confirmarlo en immigration.govt.nz antes de reservar).\n\nNueva Zelanda todavía no tiene un visado de nómada digital específico, pero desde un cambio de política efectivo el 27 de enero de 2025, quienes tienen visado de visitante o NZeTA pueden trabajar oficialmente en remoto para un empleador extranjero mientras están en el país; trabajar para un empleador neozelandés o atender a clientes locales sigue sin estar permitido. En septiembre de 2025 el gobierno anunció planes para nuevos visados dirigidos a trabajadores remotos, previstos para 2026.\n\nA efectos fiscales, Nueva Zelanda aplica la regla de los 183 días dentro de cualquier periodo móvil de 12 meses, o considera residente a quien mantiene un \"lugar de residencia permanente\" en el país. Los nuevos residentes fiscales suelen obtener una exención de 4 años sobre la mayoría de rentas de fuente extranjera, pero esa exención excluye explícitamente la renta del trabajo realizado físicamente en Nueva Zelanda, lo que significa que la mayoría de quienes trabajan en remoto viviendo allí no se benefician realmente de ella, un malentendido común y costoso.", "sources": [{ "label": "NZeTA – Immigration New Zealand (oficial)", "url": "https://nzeta.immigration.govt.nz/" }, { "label": "Trabajar en remoto desde Nueva Zelanda – Immigration New Zealand (oficial)", "url": "https://www.immigration.govt.nz/about-us/news-centre/working-remotely-from-new-zealand" }] },
    "sanidad": { "content": "MercyAscot, en Epsom, es el principal grupo hospitalario privado de Auckland, y la red Southern Cross Healthcare gestiona varios centros especializados por la ciudad; los hospitales públicos (Auckland City, North Shore, Middlemore) son de pago para visitantes, ya que la sanidad pública gratuita está reservada a ciudadanos, residentes y titulares de visados elegibles.\n\nSe recomienda encarecidamente contratar un seguro médico privado antes de llegar, ya que los no residentes deben pagar de su bolsillo cualquier tratamiento. El plan Essential de SafetyWing ronda los 63 $ cada 4 semanas, y el Complete unos 177,50 $/mes. Nueva Zelanda tiene requisitos de vacunación mínimos y sin riesgo de fiebre amarilla; basta con tener al día las vacunas de rutina (triple vírica, Tdap, gripe, COVID).", "sources": [{ "label": "Hospitales en Nueva Zelanda – InternationalInsurance.com", "url": "https://www.internationalinsurance.com/countries/new-zealand/hospitals/" }, { "label": "Southern Cross Healthcare – oficial", "url": "https://healthcare.southerncross.co.nz/specialists-and-services" }] },
    "barrios": { "content": "1. **Ponsonby** — de moda, mezcla histórica y contemporánea, 400-600 NZD/semana por un piso de una habitación, buenos bares y cafés.\n2. **Grey Lynn** — tranquilo y bohemio, 350-500 NZD/semana, popular entre creativos.\n3. **Freemans Bay** — céntrico, equilibra acceso a la ciudad y ambiente de barrio, 450-600 NZD/semana.\n4. **Parnell** — elegante y más tranquilo, con museos y buena restauración, 400-550 NZD/semana.\n5. **Newmarket** — animado y moderno, hub de compras y transporte, 450-650 NZD/semana.\n\nAlberts, en el centro, cobra 49 NZD por un pase de día; Spaces, en Commercial Bay Tower, parte de 159 NZD/mes; y Generator (tres sedes en el centro) parte de 249 NZD/mes; no existen espacios de coworking gratuitos en Auckland.", "sources": [{ "label": "Mejores barrios de Auckland para nómadas digitales – Digital Nomad Exchange", "url": "https://www.digitalnomadexchange.com/ctryguide/32637/84/New-Zealand/Living-in-Auckland-Best-Neighborhoods-for-Single-Digital-Nomads-Living-in-Auckland" }, { "label": "Mejores coworkings de Auckland – Oh, Nomad", "url": "https://ohnomad.com/best-digital-nomad-coworking-spaces-auckland/" }] },
  },
  "mascate": {
    "visaFiscal": { "content": "España está en el \"Primer Grupo\" de países exentos de visado de Omán, así que un ciudadano español puede entrar sin visado hasta 14 días, no ampliable ni convertible en visado de residencia; se exige pasaporte con al menos 6 meses de validez, billete de vuelta, reserva de hotel confirmada, seguro médico y justificante de fondos suficientes. Para estancias más largas, el sistema de eVisa de la Policía Real de Omán ofrece opciones como un visado de 10 días (unos 5 OMR) o uno de 30 días de entrada única o múltiple (unos 20-50 OMR, este último válido durante un año).\n\nOmán no cuenta con un visado de nómada digital oficial y gestionado por el gobierno; algunas webs de terceros anuncian uno, pero no está corroborado por la Policía Real de Omán ni por el Ministerio de Asuntos Exteriores, así que quienes trabajan en remoto dependen actualmente de las categorías estándar de visado turístico, de trabajo o de residencia.\n\nEn materia fiscal, Omán hizo historia en 2025 al convertirse en el primer país del Golfo en introducir un impuesto sobre la renta de las personas físicas (Real Decreto 56/2025), aunque no entrará en vigor hasta el 1 de enero de 2028. Hasta entonces, Omán sigue siendo prácticamente libre de impuestos para particulares. A partir de 2028, los residentes fiscales (183+ días/año) tributarán por su renta mundial por encima de 42.000 OMR/año al 5% sobre el exceso, con una exención única de 2 años sobre la renta extranjera incorporada de inicio, algo a tener en cuenta para quien planee una estancia de varios años.", "sources": [{ "label": "Visados de entrada – Ministerio de Asuntos Exteriores de Omán (oficial)", "url": "https://www.fm.gov.om/en/visitors/entry-visas/" }, { "label": "eVisa de Omán – Policía Real de Omán (oficial)", "url": "https://evisa.rop.gov.om/" }, { "label": "Omán introduce el impuesto sobre la renta – PwC", "url": "https://www.pwc.com/m1/en/services/tax/middle-east-tax-news-alerts/2025/oman-introduces-personal-income-tax.html" }] },
    "sanidad": { "content": "Entre los hospitales privados de referencia en Mascate están el Muscat Private Hospital (que también gestiona una clínica de inmunización/vacunas de viaje), el Aster Royal Al Raffah Hospital (del grupo Aster DM Healthcare), el Starcare Hospital (obstetricia, ginecología, pediatría) y el Apollo Hospitals Oman (cardiología, oncología). El seguro proporcionado por el empleador es habitual pero no siempre obligatorio para expatriados, así que conviene valorar una cobertura independiente o complementaria.\n\nEl plan Essential de SafetyWing ronda los 63 $ cada 4 semanas, y el Complete unos 177,50 $/mes. Entre las vacunas recomendadas están hepatitis A/B (prevalencia local media-alta), tifoidea, refuerzo de tétanos si han pasado más de 10 años, y rabia para estancias largas o actividades de mayor riesgo; el certificado de fiebre amarilla solo se exige si se llega desde un país endémico o se hace tránsito por él.", "sources": [{ "label": "Sistema sanitario en Omán – Expat.com", "url": "https://www.expat.com/en/guide/middle-east/oman/19082-the-healthcare-system-in-oman.html" }, { "label": "Omán – TravelHealthPro (NaTHNaC del Reino Unido)", "url": "https://travelhealthpro.org.uk/country/170/oman" }] },
    "barrios": { "content": "1. **Al Qurum** — animado y cosmopolita, junto al mar, 300-500 OMR/mes por un piso de una habitación, buena opción para salir a cenar y acceso a playa.\n2. **Al Khuwair** — bullicioso y multicultural, céntrico, 250-400 OMR/mes, la mejor opción para presupuestos ajustados.\n3. **Madinat Al Sultan Qaboos (MSQ)** — tranquilo y elegante, 350-450 OMR/mes.\n4. **Shatti Al Qurum** — acomodado y orientado al ocio, frente al mar, 400-600 OMR/mes.\n\nRegus opera varias sedes con puestos desde 83 OMR/mes en Al Mawaleh (la opción más económica encontrada) hasta 158 OMR/mes en Ghala Heights; Davinci Meeting Rooms y Easy Offices también tienen coworking en Shatti Al Qurum.", "sources": [{ "label": "Mejores barrios de Mascate para nómadas digitales – Digital Nomad Exchange", "url": "https://www.digitalnomadexchange.com/ctryguide/32816/210/Oman/Living-in-Muscat-Best-Neighborhoods-for-Single-Digital-Nomads-Living-in-Muscat" }, { "label": "Espacios de coworking en Mascate – Office Hub", "url": "https://www.office-hub.com/om/areas/coworking-space-in-muscat-oman-a33Qg000002jvYtIAI" }] },
  },
  "doha": {
    "visaFiscal": { "content": "Los ciudadanos españoles obtienen entrada gratuita y sin visado en Catar durante hasta 90 días, no ampliable; el Ministerio del Interior catarí incluye a España entre las 43 nacionalidades elegibles, sin coste alguno. Se exige pasaporte con al menos 3 meses de validez, billete de vuelta confirmado, reserva de hotel o dirección de anfitrión, y seguro médico de un proveedor acreditado.\n\nCatar no cuenta con ningún visado oficial de nómada digital o freelance a fecha de 2026. Quienes trabajan en remoto o por cuenta propia deben recurrir al programa de Residencia de Emprendedor (5 años, autopatrocinado, requiere aval de una incubadora, pensado para fundadores más que para empleados remotos en general), constituir una entidad empresarial con licencia, o depender del patrocinio de un empleador estándar; las reformas laborales de 2026 introdujeron disposiciones para el trabajo a tiempo parcial y freelance en principio, pero el reglamento de implementación sigue pendiente. Trabajar en remoto con un visado turístico está expresamente prohibido, sin ninguna tolerancia informal tipo \"workation\".\n\nCatar no aplica impuesto sobre la renta a salarios ni sueldos, tanto para residentes como para expatriados. Eso no implica automáticamente cero impuestos en ningún sitio: la pregunta relevante es si España sigue considerando a la persona residente fiscal según su propia regla de los 183 días, y quien no acredite correctamente la no residencia en España puede seguir tributando allí por completo, con independencia de la situación fiscal de Catar.", "sources": [{ "label": "Visados – Ministerio del Interior de Catar (oficial)", "url": "https://portal.moi.gov.qa/wps/portal/MOIInternet/departmentcommittees/visasentrypermeits/" }, { "label": "Visado freelance y de trabajo remoto en Catar: estado en 2026 – Qatar Living", "url": "https://www.qatarliving.com/en/article/freelance-remote-work-visa-qatar-legal-status" }] },
    "sanidad": { "content": "Entre los hospitales privados de referencia están el Al-Ahli Hospital (250 camas, unas 28 especialidades), el The View Hospital (colaboración con Cedars-Sinai en EE. UU.), el Aman Hospital, el Al Emadi Hospital (acreditación Platinum de Accreditation Canada International) y el Sidra Medicine, un hospital especializado de 400 camas en salud materno-infantil; la Hamad Medical Corporation es el principal proveedor público.\n\nEl seguro médico es un requisito obligatorio para los visados de residencia en Catar. El plan Essential de SafetyWing ronda los 63 $ cada 4 semanas, y el Complete unos 177,50 $/mes. Las vacunas de gripe y COVID deben estar al día, y se recomienda a los bebés de 6-11 meses una dosis temprana de triple vírica y hepatitis A antes de viajar.", "sources": [{ "label": "Hospitales privados en Catar – DohaGuides", "url": "https://www.dohaguides.com/private-hospitals-in-qatar/" }, { "label": "Hospitales en Catar – Expatica", "url": "https://www.expatica.com/qa/healthcare/healthcare-services/hospitals-in-qatar-77659/" }] },
    "barrios": { "content": "1. **The Pearl y Lusail** — caminable y elegante, frente al mar, 7.000-20.000+ QAR/mes, popular entre jóvenes profesionales y familias.\n2. **West Bay** — rascacielos del distrito de negocios cerca de embajadas, 7.000-18.000 QAR/mes, buen desplazamiento para quienes trabajan en oficina.\n3. **Msheireb Downtown Doha** — moderno y peatonal, 6.000-18.000 QAR/mes.\n4. **Al Sadd y Bin Mahmoud** — céntrico y consolidado, 5.000-13.000 QAR/mes, con buen acceso al metro.\n5. **Old Airport, Najma y Mansoura** — animado y económico, 3.500-9.000 QAR/mes.\n\nServcorp, en la Tornado Tower de West Bay, cobra unos 200 QAR/semana (unos 870 QAR/mes) por un puesto compartido con acceso 24 horas; Regus también opera varias sedes en Doha, repartidas entre West Bay, The Pearl y Lusail.", "sources": [{ "label": "Barrios recomendados para expatriados en Doha 2026 – Qatar Living", "url": "https://www.qatarliving.com/en/article/expat-friendly-neighbourhoods-doha" }, { "label": "Coworking en West Bay Doha – Office Hub", "url": "https://www.office-hub.com/qa/listings/1-person-coworking-office-west-bay-doha-a0tQg000008lLijIAE" }] },
  },
  "yakarta": {
    "visaFiscal": { "content": "Un ciudadano español puede entrar en Indonesia sin visado hasta 30 días, no ampliable; para estancias más largas o de trabajo, la mayoría recurre al visado de visita de entrada única B211A, tramitado mediante el sistema de e-Visa.\n\nEl Second Home Visa (E33) de Indonesia concede una estancia de 5 o 10 años, pero está pensado para personas con patrimonio elevado que se mudan a largo plazo, no para nómadas que trabajan: exige un depósito de 2.000 millones IDR (unos 130.000 $) en un banco estatal indonesio, o una propiedad de un millón de dólares o más, y no permite trabajar para una empresa indonesia. La opción real para nómadas digitales es el Remote Worker Visa (KITAS E33G), que exige unos ingresos anuales de fuente extranjera de al menos 60.000 $ (unos 5.000 $/mes), un extracto bancario que muestre al menos 2.000 $ mantenidos durante los tres meses previos, y un seguro médico internacional obligatorio —el seguro de viaje no es válido—. El visado debe usarse en los 90 días siguientes a su emisión o caduca.\n\nA efectos fiscales, una nueva normativa en vigor desde diciembre de 2025 aplica la regla de los 183 días dentro de cualquier periodo móvil de 12 meses, aunque también valora el tipo de visado, la presencia familiar y dónde se realiza realmente el trabajo. Los residentes fiscales tributan por su renta mundial, incluso la generada en el extranjero mientras se está físicamente en Indonesia, así que quien tenga el E33G debería esperar registrarse con un número fiscal (NPWP) y presentar declaración, en lugar de asumir que su renta extranjera queda exenta automáticamente.", "sources": [{ "label": "Second Home Visa 2026 – Emerhub", "url": "https://emerhub.com/indonesia/visas/second-home-visa/" }, { "label": "Remote Worker Visa (KITAS E33G) 2026 – Emerhub", "url": "https://emerhub.com/indonesia/visas/remote-worker-visa/" }, { "label": "Residencia fiscal en Indonesia 2026 – LegalIndonesia.id", "url": "https://legalindonesia.id/tax-residency-indonesia/" }] },
    "sanidad": { "content": "Entre los hospitales privados de referencia están el RS Pondok Indah (RSPI), con un ala dedicada a pacientes internacionales; el RS Premier Jatinegara y el RS Premier Bintaro, ambos fuertes en urgencias y cardiología; y la red Siloam Hospitals, el mayor grupo privado de Yakarta, con tratamiento sin pago directo a través de muchos aseguradores internacionales.\n\nEl plan Essential de SafetyWing ronda los 63 $ cada 4 semanas, y el Complete unos 177,50 $/mes. Tifoidea y hepatitis A/B son las vacunas más recomendadas habitualmente para una estancia en Yakarta.", "sources": [{ "label": "Mejores hospitales de Yakarta – Timedoor", "url": "https://timedoor.net/blogs/best-hospitals-in-indonesia/" }] },
    "barrios": { "content": "1. **SCBD (Sudirman CBD)** — moderno y caminable, 1.500-2.500+ $/mes, para profesionales que buscan comodidad y servicios.\n2. **Senopati** — el hub de estilo de vida más refinado de Yakarta, calles arboladas y cafés de moda, 900-1.500+ $/mes.\n3. **Blok M** — animado y ecléctico, incluye un rincón tipo \"pequeño Tokio\", 600-900 $/mes.\n4. **Kuningan** — distrito de negocios caminable con buenos cafés, 600-900 $/mes.\n5. **Kemang** — residencial, con fuerte comunidad expatriada y colegios internacionales, 600-900 $/mes.\n\nEV Hive es la opción más barata, unos 50.000 IDR/día; GoWork (unos 125.000 IDR/día) se considera generalmente el más popular; Kolega, TierSpace y Greenhouse completan las principales alternativas.", "sources": [{ "label": "Guía de nómada digital de Yakarta 2026 – Roampads", "url": "https://www.roampads.com/blog/jakarta-best-neighborhoods-digital-nomad-guide" }, { "label": "5 espacios de coworking recomendados en Yakarta – Cove.id", "url": "https://blog.cove.id/en/5-coworking-space-recommendations-in-jakarta/" }] },
  },
  "cusco": {
    "visaFiscal": { "content": "Un ciudadano español no necesita visado para hacer turismo en Perú; los sellos de entrada se conceden habitualmente hasta 90 días por entrada, con un tope acumulado de 183 días al año.\n\nEl visado de nómada digital de Perú, creado por el Decreto Legislativo 1582, nunca se ha llegado a implementar a fecha de 2026: jamás se incorporó al manual oficial de procedimientos (TUPA) de la agencia de migraciones, así que no existe forma de solicitarlo pese a que la ley exista sobre el papel. En la práctica, los nómadas dependen de sellos turísticos renovables (sin autorización de trabajo) o del visado de \"Trabajador Independiente\", una vía más duradera y renovable para quienes tienen ingresos documentados como freelance o contratista.\n\nA efectos fiscales, Perú aplica la regla de los 183 días dentro de cualquier periodo móvil de 12 meses, no ligado al año natural; cuentan tanto el día de llegada como el de salida, y las ausencias breves de menos de 183 días no reinician el contador. La residencia fiscal entra en vigor legalmente el 1 de enero del ejercicio fiscal siguiente a superar el umbral, y una vez residente, la renta mundial tributa desde el primer año a tipos progresivos (del 8% al 30%), sin periodo de gracia. Perú también participa en el Estándar Común de Reporte de la OCDE, así que las cuentas en el extranjero se reportan automáticamente.", "sources": [{ "label": "El visado de nómada digital de Perú no está disponible – Rio Times", "url": "https://www.riotimesonline.com/peru-digital-nomad-visa-not-available-2026/" }, { "label": "Impuestos en Perú para expatriados 2026 – Rio Times", "url": "https://www.riotimesonline.com/taxes-peru-expats-2026/" }] },
    "sanidad": { "content": "Cusco no cuenta con ningún gran hospital con acreditación internacional, así que las clínicas privadas son la referencia habitual para expatriados: Clínica Pardo (a menudo descrita como la más nueva y mejor equipada), Mac Salud y Clínica San José son las más recomendadas. Una consulta médica privada cuesta habitualmente entre S/60 y 80 (unos 22-30 $), y una habitación de hospital privado ronda los S/300-350/noche.\n\nEl mal de altura (soroche) es la principal preocupación de salud específica de Cusco, que se sitúa a unos 3.400 metros de altitud, y conviene tenerlo en cuenta con independencia del seguro. Entre las vacunas recomendadas están hepatitis A/B, tifoidea, refuerzo de polio y rabia para actividades de mayor riesgo; la fiebre amarilla solo es necesaria para viajes a zonas de selva o Amazonía por debajo de unos 2.300 metros, no para la propia ciudad de Cusco.", "sources": [{ "label": "Ir al médico en Cusco – The Only Peru Guide", "url": "https://www.theonlyperuguide.com/essential-peru-information-seeing-a-doctor-in-cusco/" }, { "label": "Vacunas para Perú – Passport Health", "url": "https://www.passporthealthusa.com/destination-advice/peru/" }] },
    "barrios": { "content": "1. **San Blas** — bohemio, distrito de artesanos y cafés sobre una antigua calle inca, precio medio, popular entre creativos.\n2. **San Cristóbal** — histórico, con vistas panorámicas cerca de Sacsayhuamán, precio medio.\n3. **Santa Ana** — cuestas más suaves que San Blas, más local y auténtico, de económico a medio.\n4. **Lucrepata** — en auge y más tranquilo, cerca de San Blas, económico.\n5. **Magisterio** — la opción más barata, a 20-30 minutos del centro en bus, buena para estancias largas.\n\nSelina CoWork (Plaza de Armas y Saphi) cobra 13 $ por un pase de día, 59 $ por semana o 100 $ al mes; Ayni Center tiene buena valoración por su internet rápido, y Nomad Hideout, en Magisterio, combina coworking con habitaciones desde unos 11 $/noche.", "sources": [{ "label": "Dónde alojarse en Cusco – HalfDigitalNomad", "url": "https://halfdigitalnomad.com/where-to-stay-in-cusco-best-neighborhoods/" }, { "label": "Guía de Cusco – Digital Nomads World", "url": "https://digitalnomads.world/city-guide/cusco/" }] },
  },
  "cartagena": {
    "visaFiscal": { "content": "Un ciudadano español puede entrar en Colombia sin visado durante un máximo de 90 días, prorrogables una vez por otros 90 a través de Migración Colombia. El visado de nómada digital de Colombia (la Visa V) exige un ingreso mensual mínimo equivalente a 3 veces el salario mínimo legal del país (unos COP 4.270.500, aproximadamente 1.100 $/mes), acreditado con extractos bancarios de los últimos tres meses, más un seguro médico privado obligatorio que cubra tratamiento médico, urgencias, hospitalización y repatriación durante toda la vigencia del visado.\n\nTiene una validez de hasta 2 años, renovable, y cuesta en torno a COP 1.030.000 en total (225-235 $, repartidos entre la tasa de estudio y la de expedición), con un plazo de tramitación habitual de 2 a 6 semanas.\n\nEn materia fiscal, Colombia aplica la regla de los 183 días dentro de cualquier periodo móvil de 365 días, no del año natural, y cuentan tanto el día de entrada como el de salida, por lo que salir brevemente del país no reinicia el contador; la DIAN, la autoridad fiscal, hace seguimiento de esto a través de los sellos del pasaporte y del registro Check-Mig. Los residentes fiscales tributan por su renta mundial, mientras que los no residentes solo tributan por la renta de origen colombiano. Colombia tiene un convenio de doble imposición con España que incluye las reglas de desempate habituales, pero tener el visado no exime automáticamente de la residencia fiscal, una confusión habitual y costosa.", "sources": [{ "label": "Colombia Digital Nomad Visa 2026 – Citizen Remote", "url": "https://citizenremote.com/visas/colombia/" }, { "label": "Colombia Tax Residency: The 183-Day Rule 2026 – ColombiaMove", "url": "https://colombiamove.com/blog/colombia-tax-residency-rule-expats-2026/" }] },
    "sanidad": { "content": "Entre los hospitales privados de referencia están el Hospital Universitario Carlos Haime, en Serena del Mar, el centro más moderno de la costa y sede del primer centro oncológico dedicado de la región, con el mejor soporte para pacientes internacionales; el Nuevo Hospital Bocagrande, en la zona turística, con urgencias 24 horas; y la Clínica Bicentenario, para cirugía general y maternidad, a un precio más intermedio. Para atención muy especializada, como oncología avanzada o neurocirugía, lo habitual es desplazarse a Medellín o Bogotá.\n\nNo hace falta ninguna vacuna obligatoria para el núcleo urbano de Cartagena; la fiebre amarilla solo se recomienda para excursiones a zonas de selva, Amazonía u Orinoquía, y debe ponerse al menos 10 días antes del viaje.", "sources": [{ "label": "Mejores hospitales de Cartagena – MyLatinLife", "url": "https://mylatinlife.com/2022/05/14/best-5-hospitals-in-cartagena/" }, { "label": "Salud y vacunas – Colombia.travel (oficial)", "url": "https://colombia.travel/es/informacion-practica/salud-y-vacunas" }] },
    "barrios": { "content": "1. **Bocagrande** — moderno y práctico, entre COP 2,5 y 4,5 M/mes (unos 620-1.120 $), la zona con más servicios y mejor fibra de internet.\n2. **Getsemaní** — artístico y con mucha vida, con un auténtico ambiente de arte urbano, COP 1,8-3,2 M/mes, aunque la calidad del internet varía según el edificio.\n3. **Manga** — tranquilo, residencial y muy local, COP 1,5-2,8 M/mes, la opción más barata aunque depende más de Uber para moverse.\n4. **Castillogrande** — elegante y tranquilo, entre un 10% y un 20% más caro que Bocagrande.\n\nSelina Cartagena Cowork, en Getsemaní, cuesta unos 134 $/mes; Coworking Bocagrande 24/6 cobra 5,20 $/hora, 13 $ el medio día o 23 $ el día completo, con acceso 24 horas seis días a la semana y terraza con vistas al mar.", "sources": [{ "label": "Mejores barrios de Cartagena para expats – ColombiaMove", "url": "https://colombiamove.com/blog/best-neighborhoods-cartagena-expats-remote-workers/" }, { "label": "Mejores coworkings de Cartagena – Holafly", "url": "https://esim.holafly.com/digital-nomad/coworking-cartagena/" }] },
  },
  "panama": {
    "visaFiscal": { "content": "Un ciudadano español entra en Panamá sin visado durante un máximo de 90 días. Para estancias más largas, la Visa de Estancia Corta para Trabajadores Remotos de Panamá (en vigor desde mayo de 2021) exige unos ingresos anuales extranjeros mínimos de 36.000 $ (acreditados con tres meses de extractos bancarios o nóminas), un seguro médico internacional privado obligatorio que cubra toda la estancia incluida la hospitalización, y un certificado de antecedentes penales limpio del país de residencia.\n\nEl visado tiene una validez inicial de 9 meses, con una prórroga única de otros 9 meses disponible (18 meses en total), cuesta 250 $ en tasas gubernamentales más 50 $ por la tarjeta de inmigración (a lo que hay que sumar traducciones y legalizaciones), y su tramitación tarda entre 30 y 45 días hábiles aproximadamente.\n\nPanamá aplica un sistema fiscal territorial: la renta obtenida en el extranjero queda, por lo general, fuera de la base imponible panameña, lo que supone un atractivo importante para quienes trabajan en remoto con clientes o empleador fuera del país. La residencia fiscal se activa al superar los 183 días en un año natural, o al establecer en Panamá el domicilio principal o el centro de intereses económicos y familiares, independientemente del número de días. La red de convenios de doble imposición de Panamá es limitada, así que el alivio fiscal por convenio no está garantizado para todas las nacionalidades, y tener el visado de residencia no implica automáticamente ser residente fiscal panameño: son dos cuestiones distintas, una fuente habitual de confusión.", "sources": [{ "label": "Panama Digital Nomad Visa 2025 – Citizen Remote", "url": "https://citizenremote.com/visas/panama-digital-nomad-visa/" }, { "label": "Tax Residency in Panama: 183-Day Rule 2026 – Rio Times", "url": "https://www.riotimesonline.com/tax-residency-panama-183-day-2026/" }] },
    "sanidad": { "content": "Entre los hospitales privados de referencia en Ciudad de Panamá están el Hospital Punta Pacífica, el único afiliado a Johns Hopkins en toda Centroamérica, con más de 350 especialistas; el Hospital Paitilla, uno de los hospitales privados más antiguos, con muchos médicos formados en Estados Unidos y Europa y un departamento de oncología sólido; el Hospital Nacional, en Bella Vista; y el Hospital Santa Fe, cerca del Canal, conocido por sus programas de turismo médico.\n\nPanamá exige la vacuna de la fiebre amarilla a los viajeros que llegan de países de riesgo, y también se recomienda para quien vaya a desplazarse al Darién o a otras zonas de selva.", "sources": [{ "label": "Mejores hospitales de Panamá para expats – VivaTropical", "url": "https://vivatropical.com/panama/best-hospitals-for-expats-in-panama/" }] },
    "barrios": { "content": "1. **El Cangrejo** — barrio con mucha vida de comunidad, con cafeterías y librerías, fuerte presencia de expatriados, 1.200-1.700 $/mes.\n2. **San Francisco** — equilibrado y moderno, con una oferta gastronómica en auge, 1.500-2.100 $/mes.\n3. **Casco Viejo** — histórico y muy caminable, con la mejor vida nocturna y gastronomía, 1.800-2.500 $/mes.\n4. **Clayton** — suburbano, verde y tranquilo, 1.400-2.000 $/mes.\n\nCascoStation, en Casco Viejo, y Coworking PTY son las opciones mejor valoradas; un puesto flexible en la ciudad cuesta de media unos 300 $/mes, con bonos de día desde unos 7 $.", "sources": [{ "label": "Mejores comunidades de expatriados en Panamá – Relofirm", "url": "https://www.relofirm.com/blog/top_five_expat_friendly_areas_of_panama_city/" }, { "label": "Mejores coworkings de Ciudad de Panamá – Nomads.com", "url": "https://nomads.com/coworking/panama-city" }] },
  },
};
